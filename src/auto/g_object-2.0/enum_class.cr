module GObject
  ...
  class EnumClass
    ...
    def values : GObject::EnumValue
      # Property getter
      _var = (@pointer + 24).as(Pointer(Pointer(LibGObject::EnumValue)))
      GObject::EnumValue.new(_var.value, GICrystal::Transfer::Full)
    end

    def values=(value : GObject::EnumValue)
      # Property setter
      _var = (@pointer + 24).as(Pointer(Pointer(LibGObject::EnumValue))).value = value.to_unsafe
      value
    end

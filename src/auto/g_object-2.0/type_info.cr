module GObject
  ...
  class TypeInfo
    ...
    def self.new(class_size : UInt16? = nil, base_init : Pointer(Void)? = nil, base_finalize : Pointer(Void)? = nil, class_init : Pointer(Void)? = nil, class_finalize : Pointer(Void)? = nil, class_data : Pointer(Nil)? = nil, instance_size : UInt16? = nil, n_preallocs : UInt16? = nil, instance_init : Pointer(Void)? = nil, value_table : GObject::TypeValueTable? = nil)
    ...
    def base_init=(value : Pointer(Void))
      # Property setter
      _var = (@pointer + 8).as(Pointer(LibGObject::BaseInitFunc)).value = value.to_unsafe
      value
    end
    ...
    def base_finalize=(value : Pointer(Void))
      # Property setter
      _var = (@pointer + 16).as(Pointer(LibGObject::BaseFinalizeFunc)).value = value.to_unsafe
      value
    end
    ...
    def class_init=(value : Pointer(Void))
      # Property setter
      _var = (@pointer + 24).as(Pointer(LibGObject::ClassInitFunc)).value = value.to_unsafe
      value
    end
    ...
    def class_finalize=(value : Pointer(Void))
      # Property setter
      _var = (@pointer + 32).as(Pointer(LibGObject::ClassFinalizeFunc)).value = value.to_unsafe
      value
    end

    def class_data : Pointer(Nil)
      # Property getter
      _var = (@pointer + 40).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def class_data=(value : Pointer(Nil))
      # Property setter
    ...
    def instance_init=(value : Pointer(Void))
      # Property setter
      _var = (@pointer + 56).as(Pointer(LibGObject::InstanceInitFunc)).value = value.to_unsafe
      value
    end

    def value_table : GObject::TypeValueTable
      # Property getter
      _var = (@pointer + 64).as(Pointer(Pointer(LibGObject::TypeValueTable)))
      GObject::TypeValueTable.new(_var.value, GICrystal::Transfer::Full)
    end

    def value_table=(value : GObject::TypeValueTable)
      # Property setter
      _var = (@pointer + 64).as(Pointer(Pointer(LibGObject::TypeValueTable))).value = value.to_unsafe
      value
    end

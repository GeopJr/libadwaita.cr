module GObject
  ...
  class Closure
    ...
    def notifiers : GObject::ClosureNotifyData
      # Property getter
      _var = (@pointer + 56).as(Pointer(Pointer(LibGObject::ClosureNotifyData)))
      GObject::ClosureNotifyData.new(_var.value, GICrystal::Transfer::Full)
    end

    def notifiers=(value : GObject::ClosureNotifyData)
      # Property setter
      _var = (@pointer + 56).as(Pointer(Pointer(LibGObject::ClosureNotifyData))).value = value.to_unsafe
      value
    end
    ...
    def self.new_object(sizeof_closure : UInt32, object : GObject::Object) : GObject::Closure
    ...
    def self.new_simple(sizeof_closure : UInt32, data : Pointer(Nil)?) : GObject::Closure
    ...
    def invoke(param_values : Enumerable(_), invocation_hint : Pointer(Nil)?) : GObject::Value

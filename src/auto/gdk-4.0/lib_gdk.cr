...
lib LibGdk
  ...
  fun gdk_clipboard_read_finish(this : Void*, result : Pointer(Void), out_mime_type : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  ...
  fun gdk_clipboard_read_text_finish(this : Void*, result : Pointer(Void)) : Pointer(LibC::Char)
  ...
  fun gdk_clipboard_read_texture_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_clipboard_read_value_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_clipboard_store_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun gdk_content_deserialize_finish(result : Pointer(Void), value : Pointer(Void)) : LibC::Int
  ...
  fun gdk_content_provider_get_value(this : Void*, value : Pointer(Void)) : LibC::Int
  ...
  fun gdk_content_provider_write_mime_type_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun gdk_content_serialize_finish(result : Pointer(Void)) : LibC::Int
  ...
  fun gdk_display_create_gl_context(this : Void*) : Pointer(Void)
  ...
  fun gdk_display_prepare_gl(this : Void*) : LibC::Int
  ...
  fun gdk_drop_read_finish(this : Void*, result : Pointer(Void), out_mime_type : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  ...
  fun gdk_drop_read_value_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_gl_context_realize(this : Void*) : LibC::Int
  ...
  fun gdk_surface_create_gl_context(this : Void*) : Pointer(Void)
  fun gdk_surface_create_similar_surface(this : Void*, content : UInt32, width : Int32, height : Int32) : Pointer(Void)
  fun gdk_surface_create_vulkan_context(this : Void*) : Pointer(Void)
  ...
  fun gdk_texture_new_from_bytes(bytes : Pointer(Void)) : Pointer(Void)
  fun gdk_texture_new_from_file(file : Pointer(Void)) : Pointer(Void)

...
module Gdk
  ...
  class ContentProvider < GObject::Object
    ...
    def self.new_for_value(value : _) : Gdk::ContentProvider
    ...
    def self.new_union(providers : Enumerable(Gdk::ContentProvider)?) : Gdk::ContentProvider
    ...
    def write_mime_type_async(mime_type : ::String, stream : Gio::OutputStream, io_priority : Int32, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def write_mime_type_finish(result : Gio::AsyncResult) : Bool
      ...
      _retval = LibGdk.gdk_content_provider_write_mime_type_finish(self, result)
      GICrystal.to_bool(_retval)
    end

...
module Gdk
  ...
  class Surface < GObject::Object
    ...
    def self.new_popup(parent : Gdk::Surface, autohide : Bool) : Gdk::Surface
    ...
    def self.new_toplevel(display : Gdk::Display) : Gdk::Surface
    ...
    def create_gl_context : Gdk::GLContext
      ...
      _retval = LibGdk.gdk_surface_create_gl_context(self)
    ...
    def create_vulkan_context : Gdk::VulkanContext
      ...
      _retval = LibGdk.gdk_surface_create_vulkan_context(self)

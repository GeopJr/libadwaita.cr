...
module Gdk
  ...
  class Drag < GObject::Object
    ...
    def content=(value : ContentProvider?) : ContentProvider?
      unsafe_value = value
    ...
    def selected_action : Gdk::DragAction
      # gdk_drag_get_selected_action: (Method)
      # Returns: (transfer none)

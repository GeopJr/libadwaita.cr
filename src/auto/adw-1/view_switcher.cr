...
module Adw
  ...
  #
  # Most applications should be using `#ViewSwitcherBar` and
  # `#ViewSwitcherTitle`.
  #
  # ## CSS nodes
  #
  ...
  class ViewSwitcher < Gtk::Widget
    ...
    def self._register_derived_type(klass : Class, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, klass.name,
        sizeof(LibAdw::ViewSwitcherClass), class_init,
        sizeof(LibAdw::ViewSwitcher), instance_init, 0)
    end

    GICrystal.define_new_method(ViewSwitcher, g_object_get_qdata, g_object_set_qdata)
    ...
    def policy : Adw::ViewSwitcherPolicy
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_get_policy(@pointer)
    ...
    def stack : Adw::ViewStack?
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_get_stack(@pointer)
    ...
    def policy=(policy : Adw::ViewSwitcherPolicy) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_set_policy(@pointer, policy)
    ...
    def stack=(stack : Adw::ViewStack?) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_set_stack(@pointer, stack)

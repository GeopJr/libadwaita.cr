...
module Adw
  ...
  class Animation < GObject::Object
    ...
    GICrystal.define_new_method(Animation, g_object_get_qdata, g_object_set_qdata)
    ...
    def state : Adw::AnimationState
      ...
      # C call
      _retval = LibAdw.adw_animation_get_state(@pointer)
    ...
    def target : Adw::AnimationTarget
      ...
      # C call
      _retval = LibAdw.adw_animation_get_target(@pointer)
    ...
    def value : Float64
      ...
      # C call
      _retval = LibAdw.adw_animation_get_value(@pointer)
    ...
    def widget : Gtk::Widget
      ...
      # C call
      _retval = LibAdw.adw_animation_get_widget(@pointer)
    ...
    def pause : Nil
      ...
      # C call
      LibAdw.adw_animation_pause(@pointer)
    ...
    def play : Nil
      ...
      # C call
      LibAdw.adw_animation_play(@pointer)
    ...
    def reset : Nil
      ...
      # C call
      LibAdw.adw_animation_reset(@pointer)
    ...
    def resume : Nil
      ...
      # C call
      LibAdw.adw_animation_resume(@pointer)
    ...
    def skip : Nil
      ...
      # C call
      LibAdw.adw_animation_skip(@pointer)
    ...
    struct DoneSignal
      ...
      def connect(handler : Proc(Adw::Animation, Nil))
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
      ...
      def connect_after(handler : Proc(Adw::Animation, Nil))
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Adw::Animation.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Adw::Animation, Nil)).unbox(_lib_box).call(_sender)

...
module Adw
  ...
  class EnumListItem < GObject::Object
    ...
    GICrystal.define_new_method(EnumListItem, g_object_get_qdata, g_object_set_qdata)
    ...
    def name : ::String
      ...
      # C call
      _retval = LibAdw.adw_enum_list_item_get_name(@pointer)
    ...
    def nick : ::String
      ...
      # C call
      _retval = LibAdw.adw_enum_list_item_get_nick(@pointer)
    ...
    def value : Int32
      ...
      # C call
      _retval = LibAdw.adw_enum_list_item_get_value(@pointer)

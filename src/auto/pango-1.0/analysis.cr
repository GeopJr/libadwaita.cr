module Pango
  ...
  class Analysis
    ...
    def self.new(shape_engine : Pointer(Nil)? = nil, lang_engine : Pointer(Nil)? = nil, font : Pango::Font? = nil, level : UInt8? = nil, gravity : UInt8? = nil, flags : UInt8? = nil, script : UInt8? = nil, language : Pango::Language? = nil, extra_attrs : GLib::SList? = nil)
    ...
    def font : Pango::Font
      # Property getter
      _var = (@pointer + 16).as(Pointer(Pointer(LibPango::Font)))
      Pango::Font.new(_var.value, GICrystal::Transfer::Full)
    end

    def font=(value : Pango::Font)
      # Property setter
      _var = (@pointer + 16).as(Pointer(Pointer(LibPango::Font))).value = value.to_unsafe
      value
    end
    ...
    def language : Pango::Language
      # Property getter
      _var = (@pointer + 32).as(Pointer(Pointer(LibPango::Language)))
      Pango::Language.new(_var.value, GICrystal::Transfer::Full)
    end

    def language=(value : Pango::Language)
      # Property setter
      _var = (@pointer + 32).as(Pointer(Pointer(LibPango::Language))).value = value.to_unsafe
      value
    end

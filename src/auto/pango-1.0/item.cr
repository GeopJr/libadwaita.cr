module Pango
  ...
  class Item
    ...
    def analysis : Pango::Analysis
      # Property getter
      _var = (@pointer + 16).as(Pointer(LibPango::Analysis))
      Pango::Analysis.new(_var.value, GICrystal::Transfer::Full)
    end

    def analysis=(value : Pango::Analysis)
      # Property setter
      _var = (@pointer + 16).as(Pointer(LibPango::Analysis)).value = value.to_unsafe
      value
    end

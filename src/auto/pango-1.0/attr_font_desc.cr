module Pango
  ...
  class AttrFontDesc
    ...
    def desc : Pango::FontDescription
      # Property getter
      _var = (@pointer + 16).as(Pointer(Pointer(LibPango::FontDescription)))
      Pango::FontDescription.new(_var.value, GICrystal::Transfer::Full)
    end

    def desc=(value : Pango::FontDescription)
      # Property setter
      _var = (@pointer + 16).as(Pointer(Pointer(LibPango::FontDescription))).value = value.to_unsafe
      value
    end

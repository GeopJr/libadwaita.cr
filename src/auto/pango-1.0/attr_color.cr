module Pango
  ...
  class AttrColor
    ...
    def color : Pango::Color
      # Property getter
      _var = (@pointer + 16).as(Pointer(LibPango::Color))
      Pango::Color.new(_var.value, GICrystal::Transfer::Full)
    end

    def color=(value : Pango::Color)
      # Property setter
      _var = (@pointer + 16).as(Pointer(LibPango::Color)).value = value.to_unsafe
      value
    end

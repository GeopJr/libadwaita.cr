...
lib LibGsk
  ...
  fun gsk_gl_shader_compile(this : Void*, renderer : Pointer(Void)) : LibC::Int
  ...
  fun gsk_render_node_write_to_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  ...
  fun gsk_renderer_realize(this : Void*, surface : Pointer(Void)) : LibC::Int

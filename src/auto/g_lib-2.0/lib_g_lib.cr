...
lib LibGLib
  ...
  fun g_ascii_string_to_signed(str : Pointer(LibC::Char), base : UInt32, min : Int64, max : Int64, out_num : Pointer(Int64)) : LibC::Int
  fun g_ascii_string_to_unsigned(str : Pointer(LibC::Char), base : UInt32, min : UInt64, max : UInt64, out_num : Pointer(UInt64)) : LibC::Int
  ...
  fun g_bookmark_file_get_added(this : Void*, uri : Pointer(LibC::Char)) : Int64
  fun g_bookmark_file_get_added_date_time(this : Void*, uri : Pointer(LibC::Char)) : Pointer(Void)
  fun g_bookmark_file_get_app_info(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char), exec : Pointer(Pointer(LibC::Char)), count : Pointer(UInt32), stamp : Pointer(Int64)) : LibC::Int
  fun g_bookmark_file_get_application_info(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char), exec : Pointer(Pointer(LibC::Char)), count : Pointer(UInt32), stamp : Pointer(Pointer(Void))) : LibC::Int
  fun g_bookmark_file_get_applications(this : Void*, uri : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_bookmark_file_get_description(this : Void*, uri : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_bookmark_file_get_groups(this : Void*, uri : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_bookmark_file_get_icon(this : Void*, uri : Pointer(LibC::Char), href : Pointer(Pointer(LibC::Char)), mime_type : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_bookmark_file_get_is_private(this : Void*, uri : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_get_mime_type(this : Void*, uri : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_bookmark_file_get_modified(this : Void*, uri : Pointer(LibC::Char)) : Int64
  fun g_bookmark_file_get_modified_date_time(this : Void*, uri : Pointer(LibC::Char)) : Pointer(Void)
  fun g_bookmark_file_get_size(this : Void*) : Int32
  fun g_bookmark_file_get_title(this : Void*, uri : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_bookmark_file_get_uris(this : Void*, length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_bookmark_file_get_visited(this : Void*, uri : Pointer(LibC::Char)) : Int64
  fun g_bookmark_file_get_visited_date_time(this : Void*, uri : Pointer(LibC::Char)) : Pointer(Void)
  fun g_bookmark_file_has_application(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_has_group(this : Void*, uri : Pointer(LibC::Char), group : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_has_item(this : Void*, uri : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_load_from_data(this : Void*, data : Pointer(UInt8), length : UInt64) : LibC::Int
  fun g_bookmark_file_load_from_data_dirs(this : Void*, file : Pointer(LibC::Char), full_path : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_bookmark_file_load_from_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_move_item(this : Void*, old_uri : Pointer(LibC::Char), new_uri : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_remove_application(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_remove_group(this : Void*, uri : Pointer(LibC::Char), group : Pointer(LibC::Char)) : LibC::Int
  fun g_bookmark_file_remove_item(this : Void*, uri : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_bookmark_file_set_app_info(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char), exec : Pointer(LibC::Char), count : Int32, stamp : Int64) : LibC::Int
  fun g_bookmark_file_set_application_info(this : Void*, uri : Pointer(LibC::Char), name : Pointer(LibC::Char), exec : Pointer(LibC::Char), count : Int32, stamp : Pointer(Void)) : LibC::Int
  ...
  fun g_bookmark_file_to_data(this : Void*, length : Pointer(UInt64)) : Pointer(UInt8)
  fun g_bookmark_file_to_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_clear_error : Void
  fun g_close(fd : Int32) : LibC::Int
  ...
  fun g_convert(str : Pointer(UInt8), len : Int64, to_codeset : Pointer(LibC::Char), from_codeset : Pointer(LibC::Char), bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(UInt8)
  fun g_convert_error_quark : UInt32
  fun g_convert_with_fallback(str : Pointer(UInt8), len : Int64, to_codeset : Pointer(LibC::Char), from_codeset : Pointer(LibC::Char), fallback : Pointer(LibC::Char), bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(UInt8)
  ...
  fun g_dir_make_tmp(tmpl : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_dir_make_tmp(tmpl : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_file_get_contents(filename : Pointer(LibC::Char), contents : Pointer(Pointer(UInt8)), length : Pointer(UInt64)) : LibC::Int
  fun g_file_open_tmp(tmpl : Pointer(LibC::Char), name_used : Pointer(Pointer(LibC::Char))) : Int32
  fun g_file_read_link(filename : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_file_set_contents(filename : Pointer(LibC::Char), contents : Pointer(UInt8), length : Int64) : LibC::Int
  fun g_file_set_contents_full(filename : Pointer(LibC::Char), contents : Pointer(UInt8), length : Int64, flags : UInt32, mode : Int32) : LibC::Int
  ...
  fun g_filename_from_uri(uri : Pointer(LibC::Char), hostname : Pointer(Pointer(LibC::Char))) : Pointer(LibC::Char)
  fun g_filename_from_utf8(utf8string : Pointer(LibC::Char), len : Int64, bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(LibC::Char)
  fun g_filename_to_uri(filename : Pointer(LibC::Char), hostname : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_filename_to_utf8(opsysstring : Pointer(LibC::Char), len : Int64, bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(LibC::Char)
  ...
  fun g_io_channel_error_quark : UInt32
  fun g_io_channel_flush(this : Void*) : UInt32
  ...
  fun g_io_channel_new_file(filename : Pointer(LibC::Char), mode : Pointer(LibC::Char)) : Pointer(Void)
  fun g_io_channel_read(this : Void*, buf : Pointer(LibC::Char), count : UInt64, bytes_read : Pointer(UInt64)) : UInt32
  fun g_io_channel_read_chars(this : Void*, buf : Pointer(Pointer(UInt8)), count : UInt64, bytes_read : Pointer(UInt64)) : UInt32
  fun g_io_channel_read_line(this : Void*, str_return : Pointer(Pointer(LibC::Char)), length : Pointer(UInt64), terminator_pos : Pointer(UInt64)) : UInt32
  fun g_io_channel_read_line_string(this : Void*, buffer : Pointer(Void), terminator_pos : Pointer(UInt64)) : UInt32
  fun g_io_channel_read_to_end(this : Void*, str_return : Pointer(Pointer(UInt8)), length : Pointer(UInt64)) : UInt32
  fun g_io_channel_read_unichar(this : Void*, thechar : Pointer(UInt32)) : UInt32
  fun g_io_channel_ref(this : Void*) : Pointer(Void)
  fun g_io_channel_seek(this : Void*, offset : Int64, type : UInt32) : UInt32
  fun g_io_channel_seek_position(this : Void*, offset : Int64, type : UInt32) : UInt32
  ...
  fun g_io_channel_set_encoding(this : Void*, encoding : Pointer(LibC::Char)) : UInt32
  fun g_io_channel_set_flags(this : Void*, flags : UInt32) : UInt32
  fun g_io_channel_set_line_term(this : Void*, line_term : Pointer(LibC::Char), length : Int32) : Void
  fun g_io_channel_shutdown(this : Void*, flush : LibC::Int) : UInt32
  ...
  fun g_io_channel_write_chars(this : Void*, buf : Pointer(UInt8), count : Int64, bytes_written : Pointer(UInt64)) : UInt32
  fun g_io_channel_write_unichar(this : Void*, thechar : UInt32) : UInt32
  fun g_io_create_watch(channel : Pointer(Void), condition : UInt32) : Pointer(Void)
  fun g_key_file_error_quark : UInt32
  fun g_key_file_error_quark : UInt32
  fun g_key_file_get_boolean(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : LibC::Int
  fun g_key_file_get_boolean_list(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(LibC::Int)
  fun g_key_file_get_comment(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_key_file_get_double(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Float64
  fun g_key_file_get_double_list(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Float64)
  fun g_key_file_get_groups(this : Void*, length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_key_file_get_int64(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Int64
  fun g_key_file_get_integer(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Int32
  fun g_key_file_get_integer_list(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Int32)
  fun g_key_file_get_keys(this : Void*, group_name : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  ...
  fun g_key_file_get_locale_string(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), locale : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_key_file_get_locale_string_list(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), locale : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_key_file_get_start_group(this : Void*) : Pointer(LibC::Char)
  fun g_key_file_get_string(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_key_file_get_string_list(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), length : Pointer(UInt64)) : Pointer(Pointer(LibC::Char))
  fun g_key_file_get_type : UInt64
  fun g_key_file_get_uint64(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : UInt64
  fun g_key_file_get_value(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_key_file_has_group(this : Void*, group_name : Pointer(LibC::Char)) : LibC::Int
  fun g_key_file_load_from_bytes(this : Void*, bytes : Pointer(Void), flags : UInt32) : LibC::Int
  fun g_key_file_load_from_data(this : Void*, data : Pointer(LibC::Char), length : UInt64, flags : UInt32) : LibC::Int
  fun g_key_file_load_from_data_dirs(this : Void*, file : Pointer(LibC::Char), full_path : Pointer(Pointer(LibC::Char)), flags : UInt32) : LibC::Int
  fun g_key_file_load_from_dirs(this : Void*, file : Pointer(LibC::Char), search_dirs : Pointer(Pointer(LibC::Char)), full_path : Pointer(Pointer(LibC::Char)), flags : UInt32) : LibC::Int
  fun g_key_file_load_from_file(this : Void*, file : Pointer(LibC::Char), flags : UInt32) : LibC::Int
  fun g_key_file_new : Pointer(Void)
  fun g_key_file_remove_comment(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : LibC::Int
  fun g_key_file_remove_group(this : Void*, group_name : Pointer(LibC::Char)) : LibC::Int
  fun g_key_file_remove_key(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char)) : LibC::Int
  fun g_key_file_save_to_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_key_file_set_comment(this : Void*, group_name : Pointer(LibC::Char), key : Pointer(LibC::Char), comment : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_key_file_to_data(this : Void*, length : Pointer(UInt64)) : Pointer(LibC::Char)
  fun g_key_file_unref(this : Void*) : Void
  fun g_listenv : Pointer(Pointer(LibC::Char))
  fun g_locale_from_utf8(utf8string : Pointer(LibC::Char), len : Int64, bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(UInt8)
  fun g_locale_to_utf8(opsysstring : Pointer(UInt8), len : Int64, bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : Pointer(LibC::Char)
  ...
  fun g_mapped_file_new(filename : Pointer(LibC::Char), writable : LibC::Int) : Pointer(Void)
  fun g_mapped_file_new_from_fd(fd : Int32, writable : LibC::Int) : Pointer(Void)
  ...
  fun g_markup_parse_context_end_parse(this : Void*) : LibC::Int
  ...
  fun g_markup_parse_context_parse(this : Void*, text : Pointer(LibC::Char), text_len : Int64) : LibC::Int
  ...
  fun g_match_info_expand_references(this : Void*, string_to_expand : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_match_info_next(this : Void*) : LibC::Int
  ...
  fun g_option_context_parse(this : Void*, argc : Pointer(Int32), argv : Pointer(Pointer(Pointer(LibC::Char)))) : LibC::Int
  fun g_option_context_parse_strv(this : Void*, arguments : Pointer(Pointer(Pointer(LibC::Char)))) : LibC::Int
  ...
  fun g_regex_check_replacement(replacement : Pointer(LibC::Char), has_references : Pointer(LibC::Int)) : LibC::Int
  fun g_regex_check_replacement(replacement : Pointer(LibC::Char), has_references : Pointer(LibC::Int)) : LibC::Int
  ...
  fun g_regex_match_all_full(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, match_options : UInt32, match_info : Pointer(Pointer(Void))) : LibC::Int
  fun g_regex_match_full(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, match_options : UInt32, match_info : Pointer(Pointer(Void))) : LibC::Int
  ...
  fun g_regex_match_simple(pattern : Pointer(LibC::Char), string : Pointer(LibC::Char), compile_options : UInt32, match_options : UInt32) : LibC::Int
  fun g_regex_new(pattern : Pointer(LibC::Char), compile_options : UInt32, match_options : UInt32) : Pointer(Void)
  fun g_regex_ref(this : Void*) : Pointer(Void)
  fun g_regex_replace(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, replacement : Pointer(LibC::Char), match_options : UInt32) : Pointer(LibC::Char)
  fun g_regex_replace_literal(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, replacement : Pointer(LibC::Char), match_options : UInt32) : Pointer(LibC::Char)
  fun g_regex_split(this : Void*, string : Pointer(LibC::Char), match_options : UInt32) : Pointer(Pointer(LibC::Char))
  fun g_regex_split_full(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, match_options : UInt32, max_tokens : Int32) : Pointer(Pointer(LibC::Char))
  ...
  fun g_shell_parse_argv(command_line : Pointer(LibC::Char), argcp : Pointer(Int32), argvp : Pointer(Pointer(Pointer(LibC::Char)))) : LibC::Int
  fun g_shell_quote(unquoted_string : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_shell_unquote(quoted_string : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_spawn_async(working_directory : Pointer(LibC::Char), argv : Pointer(Pointer(LibC::Char)), envp : Pointer(Pointer(LibC::Char)), flags : UInt32, child_setup : SpawnChildSetupFunc, user_data : Pointer(Void), child_pid : Pointer(Int32)) : LibC::Int
  fun g_spawn_async_with_fds(working_directory : Pointer(LibC::Char), argv : Pointer(Pointer(LibC::Char)), envp : Pointer(Pointer(LibC::Char)), flags : UInt32, child_setup : SpawnChildSetupFunc, user_data : Pointer(Void), child_pid : Pointer(Int32), stdin_fd : Int32, stdout_fd : Int32, stderr_fd : Int32) : LibC::Int
  ...
  fun g_spawn_check_exit_status(wait_status : Int32) : LibC::Int
  fun g_spawn_check_wait_status(wait_status : Int32) : LibC::Int
  fun g_spawn_close_pid(pid : Int32) : Void
  fun g_spawn_command_line_async(command_line : Pointer(LibC::Char)) : LibC::Int
  fun g_spawn_command_line_sync(command_line : Pointer(LibC::Char), standard_output : Pointer(Pointer(UInt8)), standard_error : Pointer(Pointer(UInt8)), wait_status : Pointer(Int32)) : LibC::Int
  fun g_spawn_error_quark : UInt32
  fun g_spawn_exit_error_quark : UInt32
  fun g_spawn_sync(working_directory : Pointer(LibC::Char), argv : Pointer(Pointer(LibC::Char)), envp : Pointer(Pointer(LibC::Char)), flags : UInt32, child_setup : SpawnChildSetupFunc, user_data : Pointer(Void), standard_output : Pointer(Pointer(UInt8)), standard_error : Pointer(Pointer(UInt8)), wait_status : Pointer(Int32)) : LibC::Int
  ...
  fun g_thread_pool_push(this : Void*, data : Pointer(Void)) : LibC::Int
  fun g_thread_pool_set_max_idle_time(interval : UInt32) : Void
  fun g_thread_pool_set_max_idle_time(interval : UInt32) : Void
  fun g_thread_pool_set_max_threads(this : Void*, max_threads : Int32) : LibC::Int
  ...
  fun g_thread_self : Pointer(Void)
  fun g_thread_try_new(name : Pointer(LibC::Char), func : ThreadFunc, data : Pointer(Void)) : Pointer(Void)
  ...
  fun g_ucs4_to_utf16(str : Pointer(UInt32), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(UInt16)
  fun g_ucs4_to_utf8(str : Pointer(UInt32), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(LibC::Char)
  ...
  fun g_unix_get_passwd_entry(user_name : Pointer(LibC::Char)) : Pointer(Void)
  fun g_unix_open_pipe(fds : Pointer(Int32), flags : Int32) : LibC::Int
  fun g_unix_set_fd_nonblocking(fd : Int32, nonblock : LibC::Int) : LibC::Int
  ...
  fun g_uri_is_valid(uri_string : Pointer(LibC::Char), flags : UInt32) : LibC::Int
  fun g_uri_is_valid(uri_string : Pointer(LibC::Char), flags : UInt32) : LibC::Int
  ...
  fun g_uri_params_iter_next(this : Void*, attribute : Pointer(Pointer(LibC::Char)), value : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_uri_parse(uri_string : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  fun g_uri_parse(uri_string : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  fun g_uri_parse_params(params : Pointer(LibC::Char), length : Int64, separators : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  fun g_uri_parse_params(params : Pointer(LibC::Char), length : Int64, separators : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  fun g_uri_parse_relative(this : Void*, uri_ref : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  ...
  fun g_uri_peek_scheme(uri : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_uri_resolve_relative(base_uri_string : Pointer(LibC::Char), uri_ref : Pointer(LibC::Char), flags : UInt32) : Pointer(LibC::Char)
  fun g_uri_resolve_relative(base_uri_string : Pointer(LibC::Char), uri_ref : Pointer(LibC::Char), flags : UInt32) : Pointer(LibC::Char)
  fun g_uri_split(uri_ref : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), userinfo : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32), path : Pointer(Pointer(LibC::Char)), query : Pointer(Pointer(LibC::Char)), fragment : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_uri_split(uri_ref : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), userinfo : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32), path : Pointer(Pointer(LibC::Char)), query : Pointer(Pointer(LibC::Char)), fragment : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_uri_split_network(uri_string : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32)) : LibC::Int
  fun g_uri_split_network(uri_string : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32)) : LibC::Int
  fun g_uri_split_with_user(uri_ref : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), user : Pointer(Pointer(LibC::Char)), password : Pointer(Pointer(LibC::Char)), auth_params : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32), path : Pointer(Pointer(LibC::Char)), query : Pointer(Pointer(LibC::Char)), fragment : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_uri_split_with_user(uri_ref : Pointer(LibC::Char), flags : UInt32, scheme : Pointer(Pointer(LibC::Char)), user : Pointer(Pointer(LibC::Char)), password : Pointer(Pointer(LibC::Char)), auth_params : Pointer(Pointer(LibC::Char)), host : Pointer(Pointer(LibC::Char)), port : Pointer(Int32), path : Pointer(Pointer(LibC::Char)), query : Pointer(Pointer(LibC::Char)), fragment : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_uri_to_string(this : Void*) : Pointer(LibC::Char)
  fun g_uri_to_string_partial(this : Void*, flags : UInt32) : Pointer(LibC::Char)
  fun g_uri_unescape_bytes(escaped_string : Pointer(LibC::Char), length : Int64, illegal_characters : Pointer(LibC::Char)) : Pointer(Void)
  fun g_uri_unescape_bytes(escaped_string : Pointer(LibC::Char), length : Int64, illegal_characters : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_utf16_to_ucs4(str : Pointer(UInt16), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(UInt32)
  fun g_utf16_to_utf8(str : Pointer(UInt16), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(LibC::Char)
  ...
  fun g_utf8_to_ucs4(str : Pointer(LibC::Char), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(UInt32)
  fun g_utf8_to_ucs4_fast(str : Pointer(LibC::Char), len : Int64, items_written : Pointer(Int64)) : Pointer(UInt32)
  fun g_utf8_to_utf16(str : Pointer(LibC::Char), len : Int64, items_read : Pointer(Int64), items_written : Pointer(Int64)) : Pointer(UInt16)
  ...
  fun g_variant_parse(type : Pointer(Void), text : Pointer(LibC::Char), limit : Pointer(LibC::Char), endptr : Pointer(LibC::Char)) : Pointer(Void)
  fun g_variant_parse(type : Pointer(Void), text : Pointer(LibC::Char), limit : Pointer(LibC::Char), endptr : Pointer(LibC::Char)) : Pointer(Void)

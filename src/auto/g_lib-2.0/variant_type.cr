module GLib
  ...
  class VariantType
    ...
    def self.new_array(element : GLib::VariantType) : GLib::VariantType
    ...
    def self.new_dict_entry(key : GLib::VariantType, value : GLib::VariantType) : GLib::VariantType
    ...
    def self.new_maybe(element : GLib::VariantType) : GLib::VariantType
    ...
    def self.new_tuple(items : Enumerable(GLib::VariantType)) : GLib::VariantType

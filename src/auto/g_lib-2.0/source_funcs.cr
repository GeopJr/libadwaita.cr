module GLib
  ...
  class SourceFuncs
    ...
    def self.new(prepare : Pointer(Void)? = nil, check : Pointer(Void)? = nil, dispatch : Pointer(Nil)? = nil, finalize : Pointer(Void)? = nil, closure_callback : Pointer(Void)? = nil, closure_marshal : Pointer(Void)? = nil)
    ...
    def dispatch : Pointer(Nil)
      # Property getter
      _var = (@pointer + 16).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def dispatch=(value : Pointer(Nil))
      # Property setter

...
module Gio
  ...
  class SettingsBackend < GObject::Object
    ...
    def changed(key : ::String, origin_tag : Pointer(Nil)?) : Nil
    ...
    def changed_tree(tree : GLib::Tree, origin_tag : Pointer(Nil)?) : Nil
    ...
    def keys_changed(path : ::String, items : Enumerable(::String), origin_tag : Pointer(Nil)?) : Nil
    ...
    def path_changed(path : ::String, origin_tag : Pointer(Nil)?) : Nil

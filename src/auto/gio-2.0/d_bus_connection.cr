...
module Gio
  ...
  class DBusConnection < GObject::Object
    ...
    def self.new_finish(res : Gio::AsyncResult) : Gio::DBusConnection
      ...
      _retval = LibGio.g_dbus_connection_new_finish(res)
      Gio::DBusConnection.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_for_address_finish(res : Gio::AsyncResult) : Gio::DBusConnection
      # g_dbus_connection_new_for_address_finish: (Constructor | Throws)
      # Returns: (transfer full)

      _retval = LibGio.g_dbus_connection_new_for_address_finish(res)
      Gio::DBusConnection.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_for_address_sync(address : ::String, flags : Gio::DBusConnectionFlags, observer : Gio::DBusAuthObserver?, cancellable : Gio::Cancellable?) : Gio::DBusConnection
      ...
      _retval = LibGio.g_dbus_connection_new_for_address_sync(address, flags, observer, cancellable)
      Gio::DBusConnection.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_sync(stream : Gio::IOStream, guid : ::String?, flags : Gio::DBusConnectionFlags, observer : Gio::DBusAuthObserver?, cancellable : Gio::Cancellable?) : Gio::DBusConnection
      ...
      _retval = LibGio.g_dbus_connection_new_sync(stream, guid, flags, observer, cancellable)
      Gio::DBusConnection.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new(stream : Gio::IOStream, guid : ::String?, flags : Gio::DBusConnectionFlags, observer : Gio::DBusAuthObserver?, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def self.new_for_address(address : ::String, flags : Gio::DBusConnectionFlags, observer : Gio::DBusAuthObserver?, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def add_filter(filter_function : Pointer(Void), user_data : Pointer(Nil)?, user_data_free_func : Pointer(Void)) : UInt32
    ...
    def call(bus_name : ::String?, object_path : ::String, interface_name : ::String, method_name : ::String, parameters : _?, reply_type : GLib::VariantType?, flags : Gio::DBusCallFlags, timeout_msec : Int32, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def call_finish(res : Gio::AsyncResult) : GLib::Variant
      ...
      _retval = LibGio.g_dbus_connection_call_finish(self, res)
    ...
    def call_sync(bus_name : ::String?, object_path : ::String, interface_name : ::String, method_name : ::String, parameters : _?, reply_type : GLib::VariantType?, flags : Gio::DBusCallFlags, timeout_msec : Int32, cancellable : Gio::Cancellable?) : GLib::Variant
      ...
      _retval = LibGio.g_dbus_connection_call_sync(self, bus_name, object_path, interface_name, method_name, parameters, reply_type, flags, timeout_msec, cancellable)
      GLib::Variant.new(_retval, GICrystal::Transfer::Full)
    end

    def call_with_unix_fd_list(bus_name : ::String?, object_path : ::String, interface_name : ::String, method_name : ::String, parameters : _?, reply_type : GLib::VariantType?, flags : Gio::DBusCallFlags, timeout_msec : Int32, fd_list : Gio::UnixFDList?, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def call_with_unix_fd_list_finish(res : Gio::AsyncResult) : GLib::Variant
      ...
      _retval = LibGio.g_dbus_connection_call_with_unix_fd_list_finish(self, out_fd_list, res)
      GLib::Variant.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def call_with_unix_fd_list_sync(bus_name : ::String?, object_path : ::String, interface_name : ::String, method_name : ::String, parameters : _?, reply_type : GLib::VariantType?, flags : Gio::DBusCallFlags, timeout_msec : Int32, fd_list : Gio::UnixFDList?, cancellable : Gio::Cancellable?) : GLib::Variant
      ...
      _retval = LibGio.g_dbus_connection_call_with_unix_fd_list_sync(self, bus_name, object_path, interface_name, method_name, parameters, reply_type, flags, timeout_msec, fd_list, out_fd_list, cancellable)
      GLib::Variant.new(_retval, GICrystal::Transfer::Full)
    end

    def close(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def close_finish(res : Gio::AsyncResult) : Bool
      ...
      _retval = LibGio.g_dbus_connection_close_finish(self, res)
    ...
    def close_sync(cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_dbus_connection_close_sync(self, cancellable)
      GICrystal.to_bool(_retval)
    end
    ...
    def emit_signal(destination_bus_name : ::String?, object_path : ::String, interface_name : ::String, signal_name : ::String, parameters : _?) : Bool
      ...
      _retval = LibGio.g_dbus_connection_emit_signal(self, destination_bus_name, object_path, interface_name, signal_name, parameters)
      GICrystal.to_bool(_retval)
    end
    ...
    def export_action_group(object_path : ::String, action_group : Gio::ActionGroup) : UInt32
      ...
      _retval = LibGio.g_dbus_connection_export_action_group(self, object_path, action_group)
      _retval
    end
    ...
    def export_menu_model(object_path : ::String, menu : Gio::MenuModel) : UInt32
      ...
      _retval = LibGio.g_dbus_connection_export_menu_model(self, object_path, menu)
      _retval
    end

    def flush(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def flush_finish(res : Gio::AsyncResult) : Bool
      ...
      _retval = LibGio.g_dbus_connection_flush_finish(self, res)
      GICrystal.to_bool(_retval)
    end
    ...
    def flush_sync(cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_dbus_connection_flush_sync(self, cancellable)
      GICrystal.to_bool(_retval)
    end
    ...
    def register_object(object_path : ::String, interface_info : Gio::DBusInterfaceInfo, method_call_closure : GObject::Closure?, get_property_closure : GObject::Closure?, set_property_closure : GObject::Closure?) : UInt32
      ...
      _retval = LibGio.g_dbus_connection_register_object_with_closures(self, object_path, interface_info, method_call_closure, get_property_closure, set_property_closure)
      _retval
    end

    def register_subtree(object_path : ::String, vtable : Gio::DBusSubtreeVTable, flags : Gio::DBusSubtreeFlags, user_data : Pointer(Nil)?, user_data_free_func : Pointer(Void)) : UInt32
      ...
      _retval = LibGio.g_dbus_connection_register_subtree(self, object_path, vtable, flags, user_data, user_data_free_func)
      _retval
    end
    ...
    def send_message(message : Gio::DBusMessage, flags : Gio::DBusSendMessageFlags) : Bool
      ...
      _retval = LibGio.g_dbus_connection_send_message(self, message, flags, out_serial)
      GICrystal.to_bool(_retval)
    end

    def send_message_with_reply(message : Gio::DBusMessage, flags : Gio::DBusSendMessageFlags, timeout_msec : Int32, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def send_message_with_reply_finish(res : Gio::AsyncResult) : Gio::DBusMessage
      ...
      _retval = LibGio.g_dbus_connection_send_message_with_reply_finish(self, res)
    ...
    def send_message_with_reply_sync(message : Gio::DBusMessage, flags : Gio::DBusSendMessageFlags, timeout_msec : Int32, cancellable : Gio::Cancellable?) : Gio::DBusMessage
      ...
      _retval = LibGio.g_dbus_connection_send_message_with_reply_sync(self, message, flags, timeout_msec, out_serial, cancellable)
      Gio::DBusMessage.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def signal_subscribe(sender : ::String?, interface_name : ::String?, member : ::String?, object_path : ::String?, arg0 : ::String?, flags : Gio::DBusSignalFlags, callback : Pointer(Void), user_data : Pointer(Nil)?, user_data_free_func : Pointer(Void)?) : UInt32

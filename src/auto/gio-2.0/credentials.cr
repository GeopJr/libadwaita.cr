...
module Gio
  ...
  class Credentials < GObject::Object
    ...
    def unix_pid : Int32
      ...
      _retval = LibGio.g_credentials_get_unix_pid(self)
      _retval
    end
    ...
    def unix_user : UInt32
      ...
      _retval = LibGio.g_credentials_get_unix_user(self)
      _retval
    end
    ...
    def is_same_user(other_credentials : Gio::Credentials) : Bool
      ...
      _retval = LibGio.g_credentials_is_same_user(self, other_credentials)
      GICrystal.to_bool(_retval)
    end

    def set_native(native_type : Gio::CredentialsType, native : Pointer(Nil)) : Nil
    ...
    def unix_user=(uid : UInt32) : Bool
      ...
      _retval = LibGio.g_credentials_set_unix_user(self, uid)
      GICrystal.to_bool(_retval)
    end

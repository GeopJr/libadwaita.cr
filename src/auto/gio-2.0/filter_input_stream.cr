...
module Gio
  ...
  class FilterInputStream < InputStream
    ...
    GICrystal.define_new_method(FilterInputStream, g_object_get_qdata, g_object_set_qdata)
    ...
    def base_stream : Gio::InputStream
      ...
      # C call
      _retval = LibGio.g_filter_input_stream_get_base_stream(@pointer)
    ...
    def close_base_stream : Bool
      ...
      # C call
      _retval = LibGio.g_filter_input_stream_get_close_base_stream(@pointer)
    ...
    def close_base_stream=(close_base : Bool) : Nil
      ...
      # C call
      LibGio.g_filter_input_stream_set_close_base_stream(@pointer, close_base)

module Gio
  ...
  module DebugController
    ...
    def debug_enabled : Bool
      ...
      # C call
      _retval = LibGio.g_debug_controller_get_debug_enabled(@pointer)
    ...
    def debug_enabled=(debug_enabled : Bool) : Nil
      ...
      # C call
      LibGio.g_debug_controller_set_debug_enabled(@pointer, debug_enabled)
  ...
  class AbstractDebugController < GObject::Object
    ...
    GICrystal.define_new_method(Gio::AbstractDebugController, g_object_get_qdata, g_object_set_qdata)

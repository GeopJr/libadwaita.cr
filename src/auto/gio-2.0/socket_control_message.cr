...
module Gio
  ...
  class SocketControlMessage < GObject::Object
    ...
    GICrystal.define_new_method(SocketControlMessage, g_object_get_qdata, g_object_set_qdata)
    ...
    def self.deserialize(level : Int32, type : Int32, data : Enumerable(UInt8)) : Gio::SocketControlMessage
      ...
      size = data.size # Generator::ArrayArgPlan
    ...
    def level : Int32
      ...
      # C call
      _retval = LibGio.g_socket_control_message_get_level(@pointer)
    ...
    def msg_type : Int32
      ...
      # C call
      _retval = LibGio.g_socket_control_message_get_msg_type(@pointer)
    ...
    def size : UInt64
      ...
      # C call
      _retval = LibGio.g_socket_control_message_get_size(@pointer)
    ...
    def serialize(data : Pointer(Void)) : Nil
      ...
      # C call
      LibGio.g_socket_control_message_serialize(@pointer, data)

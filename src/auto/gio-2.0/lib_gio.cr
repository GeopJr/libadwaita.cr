...
lib LibGio
  ...
  fun g_action_name_is_valid(action_name : Pointer(LibC::Char)) : LibC::Int
  fun g_action_parse_detailed_name(detailed_name : Pointer(LibC::Char), action_name : Pointer(Pointer(LibC::Char)), target_value : Pointer(Pointer(Void))) : LibC::Int
  fun g_action_parse_detailed_name(detailed_name : Pointer(LibC::Char), action_name : Pointer(Pointer(LibC::Char)), target_value : Pointer(Pointer(Void))) : LibC::Int
  fun g_action_print_detailed_name(action_name : Pointer(LibC::Char), target_value : Pointer(Void)) : Pointer(LibC::Char)
  fun g_action_print_detailed_name(action_name : Pointer(LibC::Char), target_value : Pointer(Void)) : Pointer(LibC::Char)
  fun g_app_info_add_supports_type(this : Void*, content_type : Pointer(LibC::Char)) : LibC::Int
  fun g_app_info_can_delete(this : Void*) : LibC::Int
  fun g_app_info_can_remove_supports_type(this : Void*) : LibC::Int
  fun g_app_info_create_from_commandline(commandline : Pointer(LibC::Char), application_name : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  fun g_app_info_create_from_commandline(commandline : Pointer(LibC::Char), application_name : Pointer(LibC::Char), flags : UInt32) : Pointer(Void)
  ...
  fun g_app_info_launch(this : Void*, files : Pointer(LibGLib::List), context : Pointer(Void)) : LibC::Int
  fun g_app_info_launch_default_for_uri(uri : Pointer(LibC::Char), context : Pointer(Void)) : LibC::Int
  fun g_app_info_launch_default_for_uri(uri : Pointer(LibC::Char), context : Pointer(Void)) : LibC::Int
  ...
  fun g_app_info_launch_default_for_uri_async(uri : Pointer(LibC::Char), context : Pointer(Void), cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_app_info_launch_default_for_uri_finish(result : Pointer(Void)) : LibC::Int
  fun g_app_info_launch_default_for_uri_finish(result : Pointer(Void)) : LibC::Int
  fun g_app_info_launch_uris(this : Void*, uris : Pointer(LibGLib::List), context : Pointer(Void)) : LibC::Int
  ...
  fun g_app_info_launch_uris_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_app_info_monitor_get : Pointer(Void)
  fun g_app_info_monitor_get_type : UInt64
  fun g_app_info_remove_supports_type(this : Void*, content_type : Pointer(LibC::Char)) : LibC::Int
  fun g_app_info_reset_type_associations(content_type : Pointer(LibC::Char)) : Void
  fun g_app_info_reset_type_associations(content_type : Pointer(LibC::Char)) : Void
  fun g_app_info_set_as_default_for_extension(this : Void*, extension : Pointer(LibC::Char)) : LibC::Int
  fun g_app_info_set_as_default_for_type(this : Void*, content_type : Pointer(LibC::Char)) : LibC::Int
  fun g_app_info_set_as_last_used_for_type(this : Void*, content_type : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_application_register(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_async_initable_init_finish(this : Void*, res : Pointer(Void)) : LibC::Int
  fun g_async_initable_new_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  ...
  fun g_async_result_legacy_propagate_error(this : Void*) : LibC::Int
  fun g_buffered_input_stream_fill(this : Void*, count : Int64, cancellable : Pointer(Void)) : Int64
  ...
  fun g_buffered_input_stream_fill_finish(this : Void*, result : Pointer(Void)) : Int64
  ...
  fun g_buffered_input_stream_read_byte(this : Void*, cancellable : Pointer(Void)) : Int32
  ...
  fun g_bus_get_finish(res : Pointer(Void)) : Pointer(Void)
  fun g_bus_get_sync(bus_type : Int32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_cancellable_set_error_if_cancelled(this : Void*) : LibC::Int
  ...
  fun g_charset_converter_new(to_charset : Pointer(LibC::Char), from_charset : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_converter_convert(this : Void*, inbuf : Pointer(UInt8), inbuf_size : UInt64, outbuf : Pointer(UInt8), outbuf_size : UInt64, flags : UInt32, bytes_read : Pointer(UInt64), bytes_written : Pointer(UInt64)) : UInt32
  ...
  fun g_credentials_get_unix_pid(this : Void*) : Int32
  fun g_credentials_get_unix_user(this : Void*) : UInt32
  fun g_credentials_is_same_user(this : Void*, other_credentials : Pointer(Void)) : LibC::Int
  fun g_credentials_new : Pointer(Void)
  fun g_credentials_set_native(this : Void*, native_type : UInt32, native : Pointer(Void)) : Void
  fun g_credentials_set_unix_user(this : Void*, uid : UInt32) : LibC::Int
  ...
  fun g_data_input_stream_read_byte(this : Void*, cancellable : Pointer(Void)) : UInt8
  fun g_data_input_stream_read_int16(this : Void*, cancellable : Pointer(Void)) : Int16
  fun g_data_input_stream_read_int32(this : Void*, cancellable : Pointer(Void)) : Int32
  fun g_data_input_stream_read_int64(this : Void*, cancellable : Pointer(Void)) : Int64
  fun g_data_input_stream_read_line(this : Void*, length : Pointer(UInt64), cancellable : Pointer(Void)) : Pointer(UInt8)
  ...
  fun g_data_input_stream_read_line_finish(this : Void*, result : Pointer(Void), length : Pointer(UInt64)) : Pointer(UInt8)
  fun g_data_input_stream_read_line_finish_utf8(this : Void*, result : Pointer(Void), length : Pointer(UInt64)) : Pointer(LibC::Char)
  fun g_data_input_stream_read_line_utf8(this : Void*, length : Pointer(UInt64), cancellable : Pointer(Void)) : Pointer(LibC::Char)
  fun g_data_input_stream_read_uint16(this : Void*, cancellable : Pointer(Void)) : UInt16
  fun g_data_input_stream_read_uint32(this : Void*, cancellable : Pointer(Void)) : UInt32
  fun g_data_input_stream_read_uint64(this : Void*, cancellable : Pointer(Void)) : UInt64
  fun g_data_input_stream_read_until(this : Void*, stop_chars : Pointer(LibC::Char), length : Pointer(UInt64), cancellable : Pointer(Void)) : Pointer(LibC::Char)
  ...
  fun g_data_input_stream_read_until_finish(this : Void*, result : Pointer(Void), length : Pointer(UInt64)) : Pointer(LibC::Char)
  fun g_data_input_stream_read_upto(this : Void*, stop_chars : Pointer(LibC::Char), stop_chars_len : Int64, length : Pointer(UInt64), cancellable : Pointer(Void)) : Pointer(LibC::Char)
  ...
  fun g_data_input_stream_read_upto_finish(this : Void*, result : Pointer(Void), length : Pointer(UInt64)) : Pointer(LibC::Char)
  ...
  fun g_data_output_stream_put_byte(this : Void*, data : UInt8, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_int16(this : Void*, data : Int16, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_int32(this : Void*, data : Int32, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_int64(this : Void*, data : Int64, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_string(this : Void*, str : Pointer(LibC::Char), cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_uint16(this : Void*, data : UInt16, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_uint32(this : Void*, data : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_data_output_stream_put_uint64(this : Void*, data : UInt64, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_datagram_based_condition_wait(this : Void*, condition : UInt32, timeout : Int64, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_datagram_based_receive_messages(this : Void*, messages : Pointer(Void), num_messages : UInt32, flags : Int32, timeout : Int64, cancellable : Pointer(Void)) : Int32
  fun g_datagram_based_send_messages(this : Void*, messages : Pointer(Void), num_messages : UInt32, flags : Int32, timeout : Int64, cancellable : Pointer(Void)) : Int32
  ...
  fun g_dbus_address_get_for_bus_sync(bus_type : Int32, cancellable : Pointer(Void)) : Pointer(LibC::Char)
  ...
  fun g_dbus_address_get_stream_finish(res : Pointer(Void), out_guid : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  fun g_dbus_address_get_stream_sync(address : Pointer(LibC::Char), out_guid : Pointer(Pointer(LibC::Char)), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_connection_call_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_call_sync(this : Void*, bus_name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), interface_name : Pointer(LibC::Char), method_name : Pointer(LibC::Char), parameters : Pointer(Void), reply_type : Pointer(Void), flags : UInt32, timeout_msec : Int32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_connection_call_with_unix_fd_list_finish(this : Void*, out_fd_list : Pointer(Pointer(Void)), res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_call_with_unix_fd_list_sync(this : Void*, bus_name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), interface_name : Pointer(LibC::Char), method_name : Pointer(LibC::Char), parameters : Pointer(Void), reply_type : Pointer(Void), flags : UInt32, timeout_msec : Int32, fd_list : Pointer(Void), out_fd_list : Pointer(Pointer(Void)), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_close(this : Void*, cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_dbus_connection_close_finish(this : Void*, res : Pointer(Void)) : LibC::Int
  fun g_dbus_connection_close_sync(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  fun g_dbus_connection_emit_signal(this : Void*, destination_bus_name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), interface_name : Pointer(LibC::Char), signal_name : Pointer(LibC::Char), parameters : Pointer(Void)) : LibC::Int
  fun g_dbus_connection_export_action_group(this : Void*, object_path : Pointer(LibC::Char), action_group : Pointer(Void)) : UInt32
  fun g_dbus_connection_export_menu_model(this : Void*, object_path : Pointer(LibC::Char), menu : Pointer(Void)) : UInt32
  fun g_dbus_connection_flush(this : Void*, cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_dbus_connection_flush_finish(this : Void*, res : Pointer(Void)) : LibC::Int
  fun g_dbus_connection_flush_sync(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_dbus_connection_new_finish(res : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_connection_new_for_address_finish(res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_new_for_address_sync(address : Pointer(LibC::Char), flags : UInt32, observer : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_new_sync(stream : Pointer(Void), guid : Pointer(LibC::Char), flags : UInt32, observer : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_register_object_with_closures(this : Void*, object_path : Pointer(LibC::Char), interface_info : Pointer(Void), method_call_closure : Pointer(Void), get_property_closure : Pointer(Void), set_property_closure : Pointer(Void)) : UInt32
  fun g_dbus_connection_register_subtree(this : Void*, object_path : Pointer(LibC::Char), vtable : Pointer(Void), flags : UInt32, user_data : Pointer(Void), user_data_free_func : LibGLib::DestroyNotify) : UInt32
  fun g_dbus_connection_remove_filter(this : Void*, filter_id : UInt32) : Void
  fun g_dbus_connection_send_message(this : Void*, message : Pointer(Void), flags : UInt32, out_serial : Pointer(UInt32)) : LibC::Int
  ...
  fun g_dbus_connection_send_message_with_reply_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_connection_send_message_with_reply_sync(this : Void*, message : Pointer(Void), flags : UInt32, timeout_msec : Int32, out_serial : Pointer(UInt32), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_interface_skeleton_export(this : Void*, connection : Pointer(Void), object_path : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_dbus_is_supported_address(string : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_dbus_message_bytes_needed(blob : Pointer(UInt8), blob_len : UInt64) : Int64
  fun g_dbus_message_copy(this : Void*) : Pointer(Void)
  ...
  fun g_dbus_message_new_from_blob(blob : Pointer(UInt8), blob_len : UInt64, capabilities : UInt32) : Pointer(Void)
  ...
  fun g_dbus_message_to_blob(this : Void*, out_size : Pointer(UInt64), capabilities : UInt32) : Pointer(UInt8)
  fun g_dbus_message_to_gerror(this : Void*) : LibC::Int
  ...
  fun g_dbus_node_info_new_for_xml(xml_data : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_dbus_object_manager_client_new_finish(res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_object_manager_client_new_for_bus(bus_type : Int32, flags : UInt32, name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), get_proxy_type_func : DBusProxyTypeFunc, get_proxy_type_user_data : Pointer(Void), get_proxy_type_destroy_notify : LibGLib::DestroyNotify, cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_dbus_object_manager_client_new_for_bus_finish(res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_object_manager_client_new_for_bus_sync(bus_type : Int32, flags : UInt32, name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), get_proxy_type_func : DBusProxyTypeFunc, get_proxy_type_user_data : Pointer(Void), get_proxy_type_destroy_notify : LibGLib::DestroyNotify, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_dbus_object_manager_client_new_sync(connection : Pointer(Void), flags : UInt32, name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), get_proxy_type_func : DBusProxyTypeFunc, get_proxy_type_user_data : Pointer(Void), get_proxy_type_destroy_notify : LibGLib::DestroyNotify, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_proxy_call_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_proxy_call_sync(this : Void*, method_name : Pointer(LibC::Char), parameters : Pointer(Void), flags : UInt32, timeout_msec : Int32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_proxy_call_with_unix_fd_list_finish(this : Void*, out_fd_list : Pointer(Pointer(Void)), res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_proxy_call_with_unix_fd_list_sync(this : Void*, method_name : Pointer(LibC::Char), parameters : Pointer(Void), flags : UInt32, timeout_msec : Int32, fd_list : Pointer(Void), out_fd_list : Pointer(Pointer(Void)), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_proxy_new_finish(res : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_proxy_new_for_bus_finish(res : Pointer(Void)) : Pointer(Void)
  fun g_dbus_proxy_new_for_bus_sync(bus_type : Int32, flags : UInt32, info : Pointer(Void), name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), interface_name : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_dbus_proxy_new_sync(connection : Pointer(Void), flags : UInt32, info : Pointer(Void), name : Pointer(LibC::Char), object_path : Pointer(LibC::Char), interface_name : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dbus_server_new_sync(address : Pointer(LibC::Char), flags : UInt32, guid : Pointer(LibC::Char), observer : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_desktop_app_info_launch_uris_as_manager(this : Void*, uris : Pointer(LibGLib::List), launch_context : Pointer(Void), spawn_flags : UInt32, user_setup : LibGLib::SpawnChildSetupFunc, user_setup_data : Pointer(Void), pid_callback : DesktopAppLaunchCallback, pid_callback_data : Pointer(Void)) : LibC::Int
  fun g_desktop_app_info_launch_uris_as_manager_with_fds(this : Void*, uris : Pointer(LibGLib::List), launch_context : Pointer(Void), spawn_flags : UInt32, user_setup : LibGLib::SpawnChildSetupFunc, user_setup_data : Pointer(Void), pid_callback : DesktopAppLaunchCallback, pid_callback_data : Pointer(Void), stdin_fd : Int32, stdout_fd : Int32, stderr_fd : Int32) : LibC::Int
  ...
  fun g_drive_eject_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_drive_eject_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_drive_poll_for_media_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_drive_start_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_drive_stop_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_client_connection_new(base_socket : Pointer(Void), server_identity : Pointer(Void)) : Pointer(Void)
  fun g_dtls_client_connection_new(base_socket : Pointer(Void), server_identity : Pointer(Void)) : Pointer(Void)
  ...
  fun g_dtls_connection_close(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_connection_close_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_connection_get_channel_binding_data(this : Void*, type : UInt32, data : Pointer(Pointer(UInt8))) : LibC::Int
  ...
  fun g_dtls_connection_handshake(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_connection_handshake_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_connection_shutdown(this : Void*, shutdown_read : LibC::Int, shutdown_write : LibC::Int, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_dtls_connection_shutdown_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_dtls_server_connection_get_type : UInt64
  fun g_dtls_server_connection_new(base_socket : Pointer(Void), certificate : Pointer(Void)) : Pointer(Void)
  fun g_dtls_server_connection_new(base_socket : Pointer(Void), certificate : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_append_to(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_append_to_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_build_attribute_list_for_copy(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(LibC::Char)
  fun g_file_copy(this : Void*, destination : Pointer(Void), flags : UInt32, cancellable : Pointer(Void), progress_callback : FileProgressCallback, progress_callback_data : Pointer(Void)) : LibC::Int
  ...
  fun g_file_copy_attributes(this : Void*, destination : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_copy_finish(this : Void*, res : Pointer(Void)) : LibC::Int
  fun g_file_create(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_create_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_create_readwrite(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_create_readwrite_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_delete(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_delete_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_eject_mountable_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_eject_mountable_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_file_enumerate_children(this : Void*, attributes : Pointer(LibC::Char), flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_enumerate_children_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_enumerator_close(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_enumerator_close_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_enumerator_iterate(this : Void*, out_info : Pointer(Pointer(Void)), out_child : Pointer(Pointer(Void)), cancellable : Pointer(Void)) : LibC::Int
  fun g_file_enumerator_next_file(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_enumerator_next_files_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_file_enumerator_set_pending(this : Void*, pending : LibC::Int) : Void
  fun g_file_equal(this : Void*, file2 : Pointer(Void)) : LibC::Int
  fun g_file_find_enclosing_mount(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_find_enclosing_mount_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_get_basename(this : Void*) : Pointer(LibC::Char)
  fun g_file_get_child(this : Void*, name : Pointer(LibC::Char)) : Pointer(Void)
  fun g_file_get_child_for_display_name(this : Void*, display_name : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_file_input_stream_query_info(this : Void*, attributes : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_input_stream_query_info_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_file_io_stream_get_etag(this : Void*) : Pointer(LibC::Char)
  fun g_file_io_stream_get_type : UInt64
  fun g_file_io_stream_query_info(this : Void*, attributes : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_io_stream_query_info_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_file_is_native(this : Void*) : LibC::Int
  fun g_file_load_bytes(this : Void*, cancellable : Pointer(Void), etag_out : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  fun g_file_load_bytes_async(this : Void*, cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_file_load_bytes_finish(this : Void*, result : Pointer(Void), etag_out : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  fun g_file_load_contents(this : Void*, cancellable : Pointer(Void), contents : Pointer(Pointer(UInt8)), length : Pointer(UInt64), etag_out : Pointer(Pointer(LibC::Char))) : LibC::Int
  ...
  fun g_file_load_contents_finish(this : Void*, res : Pointer(Void), contents : Pointer(Pointer(UInt8)), length : Pointer(UInt64), etag_out : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_file_load_partial_contents_finish(this : Void*, res : Pointer(Void), contents : Pointer(Pointer(UInt8)), length : Pointer(UInt64), etag_out : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_file_make_directory(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_make_directory_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_file_make_directory_with_parents(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_make_symbolic_link(this : Void*, symlink_value : Pointer(LibC::Char), cancellable : Pointer(Void)) : LibC::Int
  fun g_file_measure_disk_usage_finish(this : Void*, result : Pointer(Void), disk_usage : Pointer(UInt64), num_dirs : Pointer(UInt64), num_files : Pointer(UInt64)) : LibC::Int
  fun g_file_monitor(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_file_monitor_cancel(this : Void*) : LibC::Int
  fun g_file_monitor_directory(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_file_monitor_emit_event(this : Void*, child : Pointer(Void), other_file : Pointer(Void), event_type : UInt32) : Void
  fun g_file_monitor_file(this : Void*, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_mount_enclosing_volume_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_mount_mountable_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_file_move(this : Void*, destination : Pointer(Void), flags : UInt32, cancellable : Pointer(Void), progress_callback : FileProgressCallback, progress_callback_data : Pointer(Void)) : LibC::Int
  ...
  fun g_file_new_for_uri(uri : Pointer(LibC::Char)) : Pointer(Void)
  fun g_file_new_tmp(tmpl : Pointer(LibC::Char), iostream : Pointer(Pointer(Void))) : Pointer(Void)
  fun g_file_new_tmp(tmpl : Pointer(LibC::Char), iostream : Pointer(Pointer(Void))) : Pointer(Void)
  fun g_file_open_readwrite(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_open_readwrite_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_output_stream_get_etag(this : Void*) : Pointer(LibC::Char)
  fun g_file_output_stream_get_type : UInt64
  fun g_file_output_stream_query_info(this : Void*, attributes : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_output_stream_query_info_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_poll_mountable_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_file_query_default_handler(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_query_default_handler_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_query_filesystem_info(this : Void*, attributes : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_query_filesystem_info_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_query_info(this : Void*, attributes : Pointer(LibC::Char), flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_query_info_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_query_settable_attributes(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_file_query_writable_namespaces(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_file_read(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_read_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_replace(this : Void*, etag : Pointer(LibC::Char), make_backup : LibC::Int, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_replace_contents(this : Void*, contents : Pointer(UInt8), length : UInt64, etag : Pointer(LibC::Char), make_backup : LibC::Int, flags : UInt32, new_etag : Pointer(Pointer(LibC::Char)), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_replace_contents_finish(this : Void*, res : Pointer(Void), new_etag : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_file_replace_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_replace_readwrite(this : Void*, etag : Pointer(LibC::Char), make_backup : LibC::Int, flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_replace_readwrite_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  fun g_file_resolve_relative_path(this : Void*, relative_path : Pointer(LibC::Char)) : Pointer(Void)
  fun g_file_set_attribute(this : Void*, attribute : Pointer(LibC::Char), type : UInt32, value_p : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_byte_string(this : Void*, attribute : Pointer(LibC::Char), value : Pointer(LibC::Char), flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_int32(this : Void*, attribute : Pointer(LibC::Char), value : Int32, flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_int64(this : Void*, attribute : Pointer(LibC::Char), value : Int64, flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_string(this : Void*, attribute : Pointer(LibC::Char), value : Pointer(LibC::Char), flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_uint32(this : Void*, attribute : Pointer(LibC::Char), value : UInt32, flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_attribute_uint64(this : Void*, attribute : Pointer(LibC::Char), value : UInt64, flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_set_attributes_finish(this : Void*, result : Pointer(Void), info : Pointer(Pointer(Void))) : LibC::Int
  fun g_file_set_attributes_from_info(this : Void*, info : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_file_set_display_name(this : Void*, display_name : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_set_display_name_finish(this : Void*, res : Pointer(Void)) : Pointer(Void)
  ...
  fun g_file_start_mountable_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_stop_mountable_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_file_supports_thread_contexts(this : Void*) : LibC::Int
  fun g_file_trash(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_file_trash_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_unmount_mountable_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_file_unmount_mountable_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_icon_hash(icon : Pointer(Void)) : UInt32
  fun g_icon_new_for_string(str : Pointer(LibC::Char)) : Pointer(Void)
  fun g_icon_new_for_string(str : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_inet_address_mask_new(addr : Pointer(Void), length : UInt32) : Pointer(Void)
  fun g_inet_address_mask_new_from_string(mask_string : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_initable_init(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  fun g_initable_newv(object_type : UInt64, n_parameters : UInt32, parameters : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_initable_newv(object_type : UInt64, n_parameters : UInt32, parameters : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  fun g_input_stream_clear_pending(this : Void*) : Void
  fun g_input_stream_close(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_input_stream_close_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_input_stream_read(this : Void*, buffer : Pointer(Pointer(UInt8)), count : UInt64, cancellable : Pointer(Void)) : Int64
  fun g_input_stream_read_all(this : Void*, buffer : Pointer(Pointer(UInt8)), count : UInt64, bytes_read : Pointer(UInt64), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_input_stream_read_all_finish(this : Void*, result : Pointer(Void), bytes_read : Pointer(UInt64)) : LibC::Int
  ...
  fun g_input_stream_read_bytes(this : Void*, count : UInt64, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_input_stream_read_bytes_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_input_stream_read_finish(this : Void*, result : Pointer(Void)) : Int64
  fun g_input_stream_set_pending(this : Void*) : LibC::Int
  fun g_input_stream_skip(this : Void*, count : UInt64, cancellable : Pointer(Void)) : Int64
  ...
  fun g_input_stream_skip_finish(this : Void*, result : Pointer(Void)) : Int64
  ...
  fun g_io_stream_close(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_io_stream_close_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_io_stream_set_pending(this : Void*) : LibC::Int
  ...
  fun g_io_stream_splice_finish(result : Pointer(Void)) : LibC::Int
  ...
  fun g_loadable_icon_load(this : Void*, size : Int32, type : Pointer(Pointer(LibC::Char)), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_loadable_icon_load_finish(this : Void*, res : Pointer(Void), type : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  ...
  fun g_mount_eject_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_mount_eject_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_mount_guess_content_type_finish(this : Void*, result : Pointer(Void)) : Pointer(Pointer(LibC::Char))
  fun g_mount_guess_content_type_sync(this : Void*, force_rescan : LibC::Int, cancellable : Pointer(Void)) : Pointer(Pointer(LibC::Char))
  ...
  fun g_mount_remount_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_mount_unmount_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_mount_unmount_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_network_address_parse(host_and_port : Pointer(LibC::Char), default_port : UInt16) : Pointer(Void)
  fun g_network_address_parse_uri(uri : Pointer(LibC::Char), default_port : UInt16) : Pointer(Void)
  fun g_network_monitor_can_reach(this : Void*, connectable : Pointer(Void), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_network_monitor_can_reach_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_close(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_close_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_output_stream_flush(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_flush_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_set_pending(this : Void*) : LibC::Int
  fun g_output_stream_splice(this : Void*, source : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : Int64
  ...
  fun g_output_stream_splice_finish(this : Void*, result : Pointer(Void)) : Int64
  fun g_output_stream_write(this : Void*, buffer : Pointer(UInt8), count : UInt64, cancellable : Pointer(Void)) : Int64
  fun g_output_stream_write_all(this : Void*, buffer : Pointer(UInt8), count : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_write_all_finish(this : Void*, result : Pointer(Void), bytes_written : Pointer(UInt64)) : LibC::Int
  ...
  fun g_output_stream_write_bytes(this : Void*, bytes : Pointer(Void), cancellable : Pointer(Void)) : Int64
  ...
  fun g_output_stream_write_bytes_finish(this : Void*, result : Pointer(Void)) : Int64
  fun g_output_stream_write_finish(this : Void*, result : Pointer(Void)) : Int64
  fun g_output_stream_writev(this : Void*, vectors : Pointer(Void), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : LibC::Int
  fun g_output_stream_writev_all(this : Void*, vectors : Pointer(Void), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_output_stream_writev_all_finish(this : Void*, result : Pointer(Void), bytes_written : Pointer(UInt64)) : LibC::Int
  ...
  fun g_output_stream_writev_finish(this : Void*, result : Pointer(Void), bytes_written : Pointer(UInt64)) : LibC::Int
  fun g_permission_acquire(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_permission_acquire_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_permission_release(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_permission_release_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_pollable_input_stream_read_nonblocking(this : Void*, buffer : Pointer(Pointer(UInt8)), count : UInt64, cancellable : Pointer(Void)) : Int64
  ...
  fun g_pollable_output_stream_write_nonblocking(this : Void*, buffer : Pointer(UInt8), count : UInt64, cancellable : Pointer(Void)) : Int64
  fun g_pollable_output_stream_writev_nonblocking(this : Void*, vectors : Pointer(Void), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : Int32
  ...
  fun g_pollable_stream_read(stream : Pointer(Void), buffer : Pointer(UInt8), count : UInt64, blocking : LibC::Int, cancellable : Pointer(Void)) : Int64
  fun g_pollable_stream_write(stream : Pointer(Void), buffer : Pointer(UInt8), count : UInt64, blocking : LibC::Int, cancellable : Pointer(Void)) : Int64
  fun g_pollable_stream_write_all(stream : Pointer(Void), buffer : Pointer(UInt8), count : UInt64, blocking : LibC::Int, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_proxy_connect(this : Void*, connection : Pointer(Void), proxy_address : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_proxy_connect_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun g_proxy_resolver_lookup(this : Void*, uri : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Pointer(LibC::Char))
  ...
  fun g_proxy_resolver_lookup_finish(this : Void*, result : Pointer(Void)) : Pointer(Pointer(LibC::Char))
  ...
  fun g_resolver_lookup_by_address(this : Void*, address : Pointer(Void), cancellable : Pointer(Void)) : Pointer(LibC::Char)
  ...
  fun g_resolver_lookup_by_address_finish(this : Void*, result : Pointer(Void)) : Pointer(LibC::Char)
  fun g_resolver_lookup_by_name(this : Void*, hostname : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun g_resolver_lookup_by_name_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_resolver_lookup_by_name_with_flags(this : Void*, hostname : Pointer(LibC::Char), flags : UInt32, cancellable : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun g_resolver_lookup_by_name_with_flags_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_resolver_lookup_records(this : Void*, rrname : Pointer(LibC::Char), record_type : UInt32, cancellable : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun g_resolver_lookup_records_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_resolver_lookup_service(this : Void*, service : Pointer(LibC::Char), protocol : Pointer(LibC::Char), domain : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun g_resolver_lookup_service_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_resolver_set_default(this : Void*) : Void
  fun g_resource_enumerate_children(this : Void*, path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Pointer(LibC::Char))
  fun g_resource_error_quark : UInt32
  fun g_resource_get_info(this : Void*, path : Pointer(LibC::Char), lookup_flags : UInt32, size : Pointer(UInt64), flags : Pointer(UInt32)) : LibC::Int
  fun g_resource_get_type : UInt64
  fun g_resource_load(filename : Pointer(LibC::Char)) : Pointer(Void)
  fun g_resource_load(filename : Pointer(LibC::Char)) : Pointer(Void)
  fun g_resource_lookup_data(this : Void*, path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Void)
  fun g_resource_new_from_data(data : Pointer(Void)) : Pointer(Void)
  fun g_resource_open_stream(this : Void*, path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Void)
  fun g_resource_ref(this : Void*) : Pointer(Void)
  fun g_resource_unref(this : Void*) : Void
  fun g_resources_enumerate_children(path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Pointer(LibC::Char))
  fun g_resources_get_info(path : Pointer(LibC::Char), lookup_flags : UInt32, size : Pointer(UInt64), flags : Pointer(UInt32)) : LibC::Int
  fun g_resources_lookup_data(path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Void)
  fun g_resources_open_stream(path : Pointer(LibC::Char), lookup_flags : UInt32) : Pointer(Void)
  ...
  fun g_seekable_seek(this : Void*, offset : Int64, type : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_seekable_tell(this : Void*) : Int64
  fun g_seekable_truncate(this : Void*, offset : Int64, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_settings_schema_source_new_from_directory(directory : Pointer(LibC::Char), parent : Pointer(Void), trusted : LibC::Int) : Pointer(Void)
  ...
  fun g_simple_async_result_propagate_error(this : Void*) : LibC::Int
  ...
  fun g_socket_accept(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  fun g_socket_address_enumerator_get_type : UInt64
  fun g_socket_address_enumerator_next(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_address_enumerator_next_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_address_to_native(this : Void*, dest : Pointer(Void), destlen : UInt64) : LibC::Int
  fun g_socket_bind(this : Void*, address : Pointer(Void), allow_reuse : LibC::Int) : LibC::Int
  fun g_socket_check_connect_result(this : Void*) : LibC::Int
  fun g_socket_client_add_application_proxy(this : Void*, protocol : Pointer(LibC::Char)) : Void
  fun g_socket_client_connect(this : Void*, connectable : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_client_connect_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_socket_client_connect_to_host(this : Void*, host_and_port : Pointer(LibC::Char), default_port : UInt16, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_client_connect_to_host_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_socket_client_connect_to_service(this : Void*, domain : Pointer(LibC::Char), service : Pointer(LibC::Char), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_client_connect_to_service_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_socket_client_connect_to_uri(this : Void*, uri : Pointer(LibC::Char), default_port : UInt16, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_client_connect_to_uri_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_close(this : Void*) : LibC::Int
  fun g_socket_condition_check(this : Void*, condition : UInt32) : UInt32
  fun g_socket_condition_timed_wait(this : Void*, condition : UInt32, timeout_us : Int64, cancellable : Pointer(Void)) : LibC::Int
  fun g_socket_condition_wait(this : Void*, condition : UInt32, cancellable : Pointer(Void)) : LibC::Int
  fun g_socket_connect(this : Void*, address : Pointer(Void), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_socket_connection_connect(this : Void*, address : Pointer(Void), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_socket_connection_connect_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_socket_connection_get_local_address(this : Void*) : Pointer(Void)
  fun g_socket_connection_get_remote_address(this : Void*) : Pointer(Void)
  ...
  fun g_socket_get_credentials(this : Void*) : Pointer(Void)
  ...
  fun g_socket_get_local_address(this : Void*) : Pointer(Void)
  fun g_socket_get_multicast_loopback(this : Void*) : LibC::Int
  fun g_socket_get_multicast_ttl(this : Void*) : UInt32
  fun g_socket_get_option(this : Void*, level : Int32, optname : Int32, value : Pointer(Int32)) : LibC::Int
  fun g_socket_get_protocol(this : Void*) : Int32
  fun g_socket_get_remote_address(this : Void*) : Pointer(Void)
  ...
  fun g_socket_join_multicast_group(this : Void*, group : Pointer(Void), source_specific : LibC::Int, iface : Pointer(LibC::Char)) : LibC::Int
  fun g_socket_join_multicast_group_ssm(this : Void*, group : Pointer(Void), source_specific : Pointer(Void), iface : Pointer(LibC::Char)) : LibC::Int
  fun g_socket_leave_multicast_group(this : Void*, group : Pointer(Void), source_specific : LibC::Int, iface : Pointer(LibC::Char)) : LibC::Int
  fun g_socket_leave_multicast_group_ssm(this : Void*, group : Pointer(Void), source_specific : Pointer(Void), iface : Pointer(LibC::Char)) : LibC::Int
  fun g_socket_listen(this : Void*) : LibC::Int
  fun g_socket_listener_accept(this : Void*, source_object : Pointer(Pointer(Void)), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_listener_accept_finish(this : Void*, result : Pointer(Void), source_object : Pointer(Pointer(Void))) : Pointer(Void)
  fun g_socket_listener_accept_socket(this : Void*, source_object : Pointer(Pointer(Void)), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_socket_listener_accept_socket_finish(this : Void*, result : Pointer(Void), source_object : Pointer(Pointer(Void))) : Pointer(Void)
  fun g_socket_listener_add_address(this : Void*, address : Pointer(Void), type : UInt32, protocol : Int32, source_object : Pointer(Void), effective_address : Pointer(Pointer(Void))) : LibC::Int
  fun g_socket_listener_add_any_inet_port(this : Void*, source_object : Pointer(Void)) : UInt16
  fun g_socket_listener_add_inet_port(this : Void*, port : UInt16, source_object : Pointer(Void)) : LibC::Int
  fun g_socket_listener_add_socket(this : Void*, socket : Pointer(Void), source_object : Pointer(Void)) : LibC::Int
  ...
  fun g_socket_new(family : UInt32, type : UInt32, protocol : Int32) : Pointer(Void)
  fun g_socket_new_from_fd(fd : Int32) : Pointer(Void)
  fun g_socket_receive(this : Void*, buffer : Pointer(Pointer(UInt8)), size : Pointer(UInt64), cancellable : Pointer(Void)) : Int64
  fun g_socket_receive_from(this : Void*, address : Pointer(Pointer(Void)), buffer : Pointer(Pointer(UInt8)), size : Pointer(UInt64), cancellable : Pointer(Void)) : Int64
  fun g_socket_receive_message(this : Void*, address : Pointer(Pointer(Void)), vectors : Pointer(Void), num_vectors : Int32, messages : Pointer(Pointer(Pointer(Void))), num_messages : Pointer(Int32), flags : Pointer(Int32), cancellable : Pointer(Void)) : Int64
  fun g_socket_receive_messages(this : Void*, messages : Pointer(Void), num_messages : UInt32, flags : Int32, cancellable : Pointer(Void)) : Int32
  fun g_socket_receive_with_blocking(this : Void*, buffer : Pointer(Pointer(UInt8)), size : Pointer(UInt64), blocking : LibC::Int, cancellable : Pointer(Void)) : Int64
  fun g_socket_send(this : Void*, buffer : Pointer(UInt8), size : UInt64, cancellable : Pointer(Void)) : Int64
  fun g_socket_send_message(this : Void*, address : Pointer(Void), vectors : Pointer(Void), num_vectors : Int32, messages : Pointer(Pointer(Void)), num_messages : Int32, flags : Int32, cancellable : Pointer(Void)) : Int64
  fun g_socket_send_message_with_timeout(this : Void*, address : Pointer(Void), vectors : Pointer(Void), num_vectors : Int32, messages : Pointer(Pointer(Void)), num_messages : Int32, flags : Int32, timeout_us : Int64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void)) : Int32
  fun g_socket_send_messages(this : Void*, messages : Pointer(Void), num_messages : UInt32, flags : Int32, cancellable : Pointer(Void)) : Int32
  fun g_socket_send_to(this : Void*, address : Pointer(Void), buffer : Pointer(UInt8), size : UInt64, cancellable : Pointer(Void)) : Int64
  fun g_socket_send_with_blocking(this : Void*, buffer : Pointer(UInt8), size : UInt64, blocking : LibC::Int, cancellable : Pointer(Void)) : Int64
  ...
  fun g_socket_set_option(this : Void*, level : Int32, optname : Int32, value : Int32) : LibC::Int
  fun g_socket_set_timeout(this : Void*, timeout : UInt32) : Void
  fun g_socket_set_ttl(this : Void*, ttl : UInt32) : Void
  fun g_socket_shutdown(this : Void*, shutdown_read : LibC::Int, shutdown_write : LibC::Int) : LibC::Int
  ...
  fun g_subprocess_communicate(this : Void*, stdin_buf : Pointer(Void), cancellable : Pointer(Void), stdout_buf : Pointer(Pointer(Void)), stderr_buf : Pointer(Pointer(Void))) : LibC::Int
  ...
  fun g_subprocess_communicate_finish(this : Void*, result : Pointer(Void), stdout_buf : Pointer(Pointer(Void)), stderr_buf : Pointer(Pointer(Void))) : LibC::Int
  fun g_subprocess_communicate_utf8(this : Void*, stdin_buf : Pointer(LibC::Char), cancellable : Pointer(Void), stdout_buf : Pointer(Pointer(LibC::Char)), stderr_buf : Pointer(Pointer(LibC::Char))) : LibC::Int
  ...
  fun g_subprocess_communicate_utf8_finish(this : Void*, result : Pointer(Void), stdout_buf : Pointer(Pointer(LibC::Char)), stderr_buf : Pointer(Pointer(LibC::Char))) : LibC::Int
  ...
  fun g_subprocess_launcher_spawnv(this : Void*, argv : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  ...
  fun g_subprocess_newv(argv : Pointer(Pointer(LibC::Char)), flags : UInt32) : Pointer(Void)
  fun g_subprocess_send_signal(this : Void*, signal_num : Int32) : Void
  fun g_subprocess_wait(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  fun g_subprocess_wait_async(this : Void*, cancellable : Pointer(Void), callback : AsyncReadyCallback, user_data : Pointer(Void)) : Void
  fun g_subprocess_wait_check(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_subprocess_wait_check_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_subprocess_wait_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_task_propagate_boolean(this : Void*) : LibC::Int
  fun g_task_propagate_int(this : Void*) : Int64
  fun g_task_propagate_pointer(this : Void*) : Pointer(Void)
  fun g_task_propagate_value(this : Void*, value : Pointer(Void)) : LibC::Int
  ...
  fun g_tls_certificate_list_new_from_file(file : Pointer(LibC::Char)) : Pointer(LibGLib::List)
  fun g_tls_certificate_new_from_file(file : Pointer(LibC::Char)) : Pointer(Void)
  fun g_tls_certificate_new_from_files(cert_file : Pointer(LibC::Char), key_file : Pointer(LibC::Char)) : Pointer(Void)
  fun g_tls_certificate_new_from_pem(data : Pointer(LibC::Char), length : Int64) : Pointer(Void)
  fun g_tls_certificate_new_from_pkcs11_uris(pkcs11_uri : Pointer(LibC::Char), private_key_pkcs11_uri : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_tls_client_connection_new(base_io_stream : Pointer(Void), server_identity : Pointer(Void)) : Pointer(Void)
  fun g_tls_client_connection_new(base_io_stream : Pointer(Void), server_identity : Pointer(Void)) : Pointer(Void)
  ...
  fun g_tls_connection_get_channel_binding_data(this : Void*, type : UInt32, data : Pointer(Pointer(UInt8))) : LibC::Int
  ...
  fun g_tls_connection_handshake(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_tls_connection_handshake_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_tls_database_lookup_certificate_for_handle(this : Void*, handle : Pointer(LibC::Char), interaction : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_tls_database_lookup_certificate_for_handle_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_tls_database_lookup_certificate_issuer(this : Void*, certificate : Pointer(Void), interaction : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_tls_database_lookup_certificate_issuer_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_tls_database_lookup_certificates_issued_by(this : Void*, issuer_raw_dn : Pointer(UInt8), interaction : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun g_tls_database_lookup_certificates_issued_by_finish(this : Void*, result : Pointer(Void)) : Pointer(LibGLib::List)
  fun g_tls_database_verify_chain(this : Void*, chain : Pointer(Void), purpose : Pointer(LibC::Char), identity : Pointer(Void), interaction : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : UInt32
  ...
  fun g_tls_database_verify_chain_finish(this : Void*, result : Pointer(Void)) : UInt32
  fun g_tls_error_quark : UInt32
  fun g_tls_file_database_get_type : UInt64
  fun g_tls_file_database_new(anchors : Pointer(LibC::Char)) : Pointer(Void)
  fun g_tls_file_database_new(anchors : Pointer(LibC::Char)) : Pointer(Void)
  fun g_tls_interaction_ask_password(this : Void*, password : Pointer(Void), cancellable : Pointer(Void)) : UInt32
  ...
  fun g_tls_interaction_ask_password_finish(this : Void*, result : Pointer(Void)) : UInt32
  fun g_tls_interaction_get_type : UInt64
  fun g_tls_interaction_invoke_ask_password(this : Void*, password : Pointer(Void), cancellable : Pointer(Void)) : UInt32
  fun g_tls_interaction_invoke_request_certificate(this : Void*, connection : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : UInt32
  fun g_tls_interaction_request_certificate(this : Void*, connection : Pointer(Void), flags : UInt32, cancellable : Pointer(Void)) : UInt32
  ...
  fun g_tls_interaction_request_certificate_finish(this : Void*, result : Pointer(Void)) : UInt32
  ...
  fun g_tls_server_connection_new(base_io_stream : Pointer(Void), certificate : Pointer(Void)) : Pointer(Void)
  fun g_tls_server_connection_new(base_io_stream : Pointer(Void), certificate : Pointer(Void)) : Pointer(Void)
  fun g_unix_connection_get_type : UInt64
  fun g_unix_connection_receive_credentials(this : Void*, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun g_unix_connection_receive_credentials_finish(this : Void*, result : Pointer(Void)) : Pointer(Void)
  fun g_unix_connection_receive_fd(this : Void*, cancellable : Pointer(Void)) : Int32
  fun g_unix_connection_send_credentials(this : Void*, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_unix_connection_send_credentials_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  fun g_unix_connection_send_fd(this : Void*, fd : Int32, cancellable : Pointer(Void)) : LibC::Int
  ...
  fun g_unix_fd_list_append(this : Void*, fd : Int32) : Int32
  fun g_unix_fd_list_get(this : Void*, index_ : Int32) : Int32
  ...
  fun g_unix_fd_message_append_fd(this : Void*, fd : Int32) : LibC::Int
  ...
  fun g_volume_eject_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_volume_eject_with_operation_finish(this : Void*, result : Pointer(Void)) : LibC::Int
  ...
  fun g_volume_mount_finish(this : Void*, result : Pointer(Void)) : LibC::Int

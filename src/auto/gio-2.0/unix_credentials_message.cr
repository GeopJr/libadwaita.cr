...
module Gio
  ...
  class UnixCredentialsMessage < SocketControlMessage
    ...
    GICrystal.define_new_method(UnixCredentialsMessage, g_object_get_qdata, g_object_set_qdata)
    ...
    def credentials : Gio::Credentials
      ...
      # C call
      _retval = LibGio.g_unix_credentials_message_get_credentials(@pointer)

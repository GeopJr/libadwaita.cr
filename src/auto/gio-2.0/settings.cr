...
module Gio
  ...
  class Settings < GObject::Object
    ...
    def self.new_full(schema : Gio::SettingsSchema, backend : Gio::SettingsBackend?, path : ::String?) : Gio::Settings
    ...
    def self.new_with_backend(schema_id : ::String, backend : Gio::SettingsBackend) : Gio::Settings
    ...
    def self.new_with_backend_and_path(schema_id : ::String, backend : Gio::SettingsBackend, path : ::String) : Gio::Settings
    ...
    def self.new_with_path(schema_id : ::String, path : ::String) : Gio::Settings
    ...
    def mapped(key : ::String, mapping : Pointer(Void), user_data : Pointer(Nil)?) : Pointer(Nil)?

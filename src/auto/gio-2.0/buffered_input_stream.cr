...
module Gio
  ...
  class BufferedInputStream < FilterInputStream
    ...
    def self.new_sized(base_stream : Gio::InputStream, size : UInt64) : Gio::InputStream
    ...
    def fill(count : Int64, cancellable : Gio::Cancellable?) : Int64
      ...
      _retval = LibGio.g_buffered_input_stream_fill(self, count, cancellable)
      _retval
    end

    def fill_async(count : Int64, io_priority : Int32, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def fill_finish(result : Gio::AsyncResult) : Int64
      ...
      _retval = LibGio.g_buffered_input_stream_fill_finish(self, result)
      _retval
    end
    ...
    def peek_buffer(count : UInt64) : Enumerable(UInt8)
      # g_buffered_input_stream_peek_buffer: (Method)
      # @count: (out) (transfer full)
      # Returns: (transfer none)

      _retval = LibGio.g_buffered_input_stream_peek_buffer(self, count)
      _retval
    end
    ...
    def read_byte(cancellable : Gio::Cancellable?) : Int32
      ...
      _retval = LibGio.g_buffered_input_stream_read_byte(self, cancellable)
      _retval
    end

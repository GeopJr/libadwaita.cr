...
module Gio
  ...
  class Vfs < GObject::Object
    ...
    def register_uri_scheme(scheme : ::String, uri_func : Pointer(Void)?, uri_data : Pointer(Nil)?, uri_destroy : Pointer(Void)?, parse_name_func : Pointer(Void)?, parse_name_data : Pointer(Nil)?, parse_name_destroy : Pointer(Void)?) : Bool

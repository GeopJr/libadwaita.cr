...
module Gio
  ...
  class SocketAddress < GObject::Object
    ...
    GICrystal.define_new_method(SocketAddress, g_object_get_qdata, g_object_set_qdata)
    ...
    def family : Gio::SocketFamily
      ...
      # C call
      _retval = LibGio.g_socket_address_get_family(@pointer)
    ...
    def native_size : Int64
      ...
      # C call
      _retval = LibGio.g_socket_address_get_native_size(@pointer)
    ...
    def to_native(dest : Pointer(Void)?, destlen : UInt64) : Bool
      ...
      # C call
      _retval = LibGio.g_socket_address_to_native(@pointer, dest, destlen, pointerof(_error))

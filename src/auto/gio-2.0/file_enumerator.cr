...
module Gio
  ...
  class FileEnumerator < GObject::Object
    ...
    def close(cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_file_enumerator_close(self, cancellable)
    ...
    def close_finish(result : Gio::AsyncResult) : Bool
      ...
      _retval = LibGio.g_file_enumerator_close_finish(self, result)
      GICrystal.to_bool(_retval)
    end
    ...
    def iterate(cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_file_enumerator_iterate(self, out_info, out_child, cancellable)
      GICrystal.to_bool(_retval)
    end
    ...
    def next_file(cancellable : Gio::Cancellable?) : Gio::FileInfo?
      ...
      _retval = LibGio.g_file_enumerator_next_file(self, cancellable)
      Gio::FileInfo.new(_retval, GICrystal::Transfer::Full) unless _retval.null?
    end

    def next_files_async(num_files : Int32, io_priority : Int32, cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def next_files_finish(result : Gio::AsyncResult) : GLib::List
      ...
      _retval = LibGio.g_file_enumerator_next_files_finish(self, result)

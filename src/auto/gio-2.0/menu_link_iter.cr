...
module Gio
  ...
  class MenuLinkIter < GObject::Object
    ...
    GICrystal.define_new_method(MenuLinkIter, g_object_get_qdata, g_object_set_qdata)
    ...
    def name : ::String
      ...
      # C call
      _retval = LibGio.g_menu_link_iter_get_name(@pointer)
    ...
    def next : Bool
      ...
      # C call
      _retval = LibGio.g_menu_link_iter_get_next(@pointer, out_link, value)
    ...
    def value : Gio::MenuModel
      ...
      # C call
      _retval = LibGio.g_menu_link_iter_get_value(@pointer)
    ...
    def _next : Bool
      ...
      # C call
      _retval = LibGio.g_menu_link_iter_next(@pointer)

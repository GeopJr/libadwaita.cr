...
module Gio
  ...
  class NetworkAddress < GObject::Object
    ...
    GICrystal.define_new_method(NetworkAddress, g_object_get_qdata, g_object_set_qdata)
    ...
    def hostname : ::String
      ...
      # C call
      _retval = LibGio.g_network_address_get_hostname(@pointer)
    ...
    def port : UInt16
      ...
      # C call
      _retval = LibGio.g_network_address_get_port(@pointer)
    ...
    def scheme : ::String?
      ...
      # C call
      _retval = LibGio.g_network_address_get_scheme(@pointer)

...
module Gio
  ...
  class TcpWrapperConnection < TcpConnection
    ...
    GICrystal.define_new_method(TcpWrapperConnection, g_object_get_qdata, g_object_set_qdata)
    ...
    def base_io_stream : Gio::IOStream
      ...
      # C call
      _retval = LibGio.g_tcp_wrapper_connection_get_base_io_stream(@pointer)

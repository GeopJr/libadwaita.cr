...
module Gio
  ...
  class TcpConnection < SocketConnection
    ...
    GICrystal.define_new_method(TcpConnection, g_object_get_qdata, g_object_set_qdata)
    ...
    def graceful_disconnect : Bool
      ...
      # C call
      _retval = LibGio.g_tcp_connection_get_graceful_disconnect(@pointer)
    ...
    def graceful_disconnect=(graceful_disconnect : Bool) : Nil
      ...
      # C call
      LibGio.g_tcp_connection_set_graceful_disconnect(@pointer, graceful_disconnect)

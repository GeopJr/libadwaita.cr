...
module Gio
  ...
  class Task < GObject::Object
    ...
    def self.report_error(source_object : GObject::Object?, callback : Pointer(Void)?, callback_data : Pointer(Nil)?, source_tag : Pointer(Nil)?, error : GLib::Error) : Nil
    ...
    def propagate_boolean : Bool
      ...
      _retval = LibGio.g_task_propagate_boolean(self)
      GICrystal.to_bool(_retval)
    end
    ...
    def propagate_int : Int64
      ...
      _retval = LibGio.g_task_propagate_int(self)
      _retval
    end

    def propagate_pointer : Pointer(Nil)?
      # g_task_propagate_pointer: (Method | Throws)
      # Returns: (transfer full)

      _retval = LibGio.g_task_propagate_pointer(self)
      Pointer(Void) unless _retval.null?
    end
    ...
    def propagate_value : GObject::Value
      ...
      _retval = LibGio.g_task_propagate_value(self, value)
      value
    end
    ...
    def return_pointer(result : Pointer(Nil)?, result_destroy : Pointer(Void)?) : Nil
    ...
    def source_tag=(source_tag : Pointer(Nil)?) : Nil
    ...
    def set_task_data(task_data : Pointer(Nil)?, task_data_destroy : Pointer(Void)?) : Nil

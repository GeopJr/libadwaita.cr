...
module Gio
  ...
  class SocketListener < GObject::Object
    ...
    def accept(cancellable : Gio::Cancellable?) : Gio::SocketConnection
      ...
      _retval = LibGio.g_socket_listener_accept(self, source_object, cancellable)
      Gio::SocketConnection.new(_retval, GICrystal::Transfer::Full)
    end

    def accept_async(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def accept_finish(result : Gio::AsyncResult) : Gio::SocketConnection
      ...
      _retval = LibGio.g_socket_listener_accept_finish(self, result, source_object)
      Gio::SocketConnection.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def accept_socket(cancellable : Gio::Cancellable?) : Gio::Socket
      ...
      _retval = LibGio.g_socket_listener_accept_socket(self, source_object, cancellable)
      Gio::Socket.new(_retval, GICrystal::Transfer::Full)
    end

    def accept_socket_async(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def accept_socket_finish(result : Gio::AsyncResult) : Gio::Socket
      ...
      _retval = LibGio.g_socket_listener_accept_socket_finish(self, result, source_object)
      Gio::Socket.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def add_address(address : Gio::SocketAddress, type : Gio::SocketType, protocol : Gio::SocketProtocol, source_object : GObject::Object?) : Bool
      ...
      _retval = LibGio.g_socket_listener_add_address(self, address, type, protocol, source_object, effective_address)
    ...
    def add_any_inet_port(source_object : GObject::Object?) : UInt16
      ...
      _retval = LibGio.g_socket_listener_add_any_inet_port(self, source_object)
      _retval
    end
    ...
    def add_inet_port(port : UInt16, source_object : GObject::Object?) : Bool
      ...
      _retval = LibGio.g_socket_listener_add_inet_port(self, port, source_object)
      GICrystal.to_bool(_retval)
    end
    ...
    def add_socket(socket : Gio::Socket, source_object : GObject::Object?) : Bool
      ...
      _retval = LibGio.g_socket_listener_add_socket(self, socket, source_object)
      GICrystal.to_bool(_retval)
    end

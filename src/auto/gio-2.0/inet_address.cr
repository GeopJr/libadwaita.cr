...
module Gio
  ...
  class InetAddress < GObject::Object
    ...
    def initialize(*, bytes : Pointer(Nil)? = nil, family : Gio::SocketFamily? = nil, is_any : Bool? = nil, is_link_local : Bool? = nil, is_loopback : Bool? = nil, is_mc_global : Bool? = nil, is_mc_link_local : Bool? = nil, is_mc_node_local : Bool? = nil, is_mc_org_local : Bool? = nil, is_mc_site_local : Bool? = nil, is_multicast : Bool? = nil, is_site_local : Bool? = nil)
    ...
    def bytes=(value : Pointer(Nil)) : Pointer(Nil)
      unsafe_value = value
    ...
    def self.new_from_bytes(bytes : Enumerable(UInt8), family : Gio::SocketFamily) : Gio::InetAddress
    ...
    def self.new_from_string(string : ::String) : Gio::InetAddress?
    ...
    def self.new_loopback(family : Gio::SocketFamily) : Gio::InetAddress

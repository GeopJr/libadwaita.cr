...
module Gio
  ...
  class ListStore < GObject::Object
    ...
    def insert_sorted(item : GObject::Object, compare_func : Pointer(Void), user_data : Pointer(Nil)?) : UInt32
    ...
    def sort(compare_func : Pointer(Void), user_data : Pointer(Nil)?) : Nil

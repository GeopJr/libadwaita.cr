...
module Gio
  ...
  class UnixConnection < SocketConnection
    ...
    def receive_credentials(cancellable : Gio::Cancellable?) : Gio::Credentials
      ...
      _retval = LibGio.g_unix_connection_receive_credentials(self, cancellable)
      Gio::Credentials.new(_retval, GICrystal::Transfer::Full)
    end

    def receive_credentials_async(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def receive_credentials_finish(result : Gio::AsyncResult) : Gio::Credentials
      ...
      _retval = LibGio.g_unix_connection_receive_credentials_finish(self, result)
      Gio::Credentials.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def receive_fd(cancellable : Gio::Cancellable?) : Int32
      ...
      _retval = LibGio.g_unix_connection_receive_fd(self, cancellable)
      _retval
    end
    ...
    def send_credentials(cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_unix_connection_send_credentials(self, cancellable)
      GICrystal.to_bool(_retval)
    end

    def send_credentials_async(cancellable : Gio::Cancellable?, callback : Pointer(Void)?, user_data : Pointer(Nil)?) : Nil
    ...
    def send_credentials_finish(result : Gio::AsyncResult) : Bool
      ...
      _retval = LibGio.g_unix_connection_send_credentials_finish(self, result)
      GICrystal.to_bool(_retval)
    end
    ...
    def send_fd(fd : Int32, cancellable : Gio::Cancellable?) : Bool
      ...
      _retval = LibGio.g_unix_connection_send_fd(self, fd, cancellable)
      GICrystal.to_bool(_retval)
    end
  end
end

...
lib LibGdkPixbuf
  ...
  fun gdk_pixbuf_animation_new_from_file(filename : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_animation_new_from_resource(resource_path : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_animation_new_from_stream(stream : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_pixbuf_animation_new_from_stream_finish(async_result : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_pixbuf_get_file_info_finish(async_result : Pointer(Void), width : Pointer(Int32), height : Pointer(Int32)) : Pointer(Void)
  ...
  fun gdk_pixbuf_init_modules(path : Pointer(LibC::Char)) : LibC::Int
  fun gdk_pixbuf_loader_close(this : Void*) : LibC::Int
  ...
  fun gdk_pixbuf_loader_new_with_mime_type(mime_type : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_loader_new_with_type(image_type : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_loader_set_size(this : Void*, width : Int32, height : Int32) : Void
  fun gdk_pixbuf_loader_write(this : Void*, buf : Pointer(UInt8), count : UInt64) : LibC::Int
  fun gdk_pixbuf_loader_write_bytes(this : Void*, buffer : Pointer(Void)) : LibC::Int
  ...
  fun gdk_pixbuf_new_from_file(filename : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_new_from_file_at_scale(filename : Pointer(LibC::Char), width : Int32, height : Int32, preserve_aspect_ratio : LibC::Int) : Pointer(Void)
  fun gdk_pixbuf_new_from_file_at_size(filename : Pointer(LibC::Char), width : Int32, height : Int32) : Pointer(Void)
  fun gdk_pixbuf_new_from_inline(data_length : Int32, data : Pointer(UInt8), copy_pixels : LibC::Int) : Pointer(Void)
  fun gdk_pixbuf_new_from_resource(resource_path : Pointer(LibC::Char)) : Pointer(Void)
  fun gdk_pixbuf_new_from_resource_at_scale(resource_path : Pointer(LibC::Char), width : Int32, height : Int32, preserve_aspect_ratio : LibC::Int) : Pointer(Void)
  fun gdk_pixbuf_new_from_stream(stream : Pointer(Void), cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_pixbuf_new_from_stream_at_scale(stream : Pointer(Void), width : Int32, height : Int32, preserve_aspect_ratio : LibC::Int, cancellable : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_pixbuf_new_from_stream_finish(async_result : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_pixbuf_save_to_bufferv(this : Void*, buffer : Pointer(Pointer(UInt8)), buffer_size : Pointer(UInt64), type : Pointer(LibC::Char), option_keys : Pointer(Pointer(LibC::Char)), option_values : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun gdk_pixbuf_save_to_callbackv(this : Void*, save_func : PixbufSaveFunc, user_data : Pointer(Void), type : Pointer(LibC::Char), option_keys : Pointer(Pointer(LibC::Char)), option_values : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun gdk_pixbuf_save_to_stream_finish(async_result : Pointer(Void)) : LibC::Int
  fun gdk_pixbuf_save_to_streamv(this : Void*, stream : Pointer(Void), type : Pointer(LibC::Char), option_keys : Pointer(Pointer(LibC::Char)), option_values : Pointer(Pointer(LibC::Char)), cancellable : Pointer(Void)) : LibC::Int
  ...
  fun gdk_pixbuf_savev(this : Void*, filename : Pointer(LibC::Char), type : Pointer(LibC::Char), option_keys : Pointer(Pointer(LibC::Char)), option_values : Pointer(Pointer(LibC::Char))) : LibC::Int

module GdkPixbuf
  ...
  class PixbufFormat
    ...
    def signature : GdkPixbuf::PixbufModulePattern
      # Property getter
      _var = (@pointer + 8).as(Pointer(Pointer(LibGdkPixbuf::PixbufModulePattern)))
      GdkPixbuf::PixbufModulePattern.new(_var.value, GICrystal::Transfer::Full)
    end

    def signature=(value : GdkPixbuf::PixbufModulePattern)
      # Property setter
      _var = (@pointer + 8).as(Pointer(Pointer(LibGdkPixbuf::PixbufModulePattern))).value = value.to_unsafe
      value
    end

module GdkPixbuf
  ...
  class PixbufModule
    ...
    def self.new(module_name : ::String? = nil, module_path : ::String? = nil, module _module : GModule::Module? = nil, info : GdkPixbuf::PixbufFormat? = nil, load : Pointer(Nil)? = nil, load_xpm_data : Pointer(Nil)? = nil, begin_load : Pointer(Nil)? = nil, stop_load : Pointer(Void)? = nil, load_increment : Pointer(Void)? = nil, load_animation : Pointer(Nil)? = nil, save : Pointer(Void)? = nil, save_to_callback : Pointer(Nil)? = nil, is_save_option_supported : Pointer(Void)? = nil, _reserved1 : Pointer(Nil)? = nil, _reserved2 : Pointer(Nil)? = nil, _reserved3 : Pointer(Nil)? = nil, _reserved4 : Pointer(Nil)? = nil)
    ...
    def module : GModule::Module
      # Property getter
      _var = (@pointer + 16).as(Pointer(Pointer(LibGModule::Module)))
      GModule::Module.new(_var.value, GICrystal::Transfer::Full)
    end

    def module=(value : GModule::Module)
      # Property setter
      _var = (@pointer + 16).as(Pointer(Pointer(LibGModule::Module))).value = value.to_unsafe
      value
    end

    def info : GdkPixbuf::PixbufFormat
      # Property getter
      _var = (@pointer + 24).as(Pointer(Pointer(LibGdkPixbuf::PixbufFormat)))
      GdkPixbuf::PixbufFormat.new(_var.value, GICrystal::Transfer::Full)
    end

    def info=(value : GdkPixbuf::PixbufFormat)
      # Property setter
      _var = (@pointer + 24).as(Pointer(Pointer(LibGdkPixbuf::PixbufFormat))).value = value.to_unsafe
      value
    end

    def load : Pointer(Nil)
      # Property getter
      _var = (@pointer + 32).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def load=(value : Pointer(Nil))
      # Property setter
      _var = (@pointer + 32).as(Pointer(Pointer(Void))).value = value
      value
    end

    def load_xpm_data : Pointer(Nil)
      # Property getter
      _var = (@pointer + 40).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def load_xpm_data=(value : Pointer(Nil))
      # Property setter
      _var = (@pointer + 40).as(Pointer(Pointer(Void))).value = value
      value
    end

    def begin_load : Pointer(Nil)
      # Property getter
      _var = (@pointer + 48).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def begin_load=(value : Pointer(Nil))
      # Property setter
    ...
    def load_animation : Pointer(Nil)
      # Property getter
      _var = (@pointer + 72).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def load_animation=(value : Pointer(Nil))
      # Property setter
    ...
    def save_to_callback : Pointer(Nil)
      # Property getter
      _var = (@pointer + 88).as(Pointer(Pointer(Void)))
      Pointer(Void)
    end

    def save_to_callback=(value : Pointer(Nil))
      # Property setter

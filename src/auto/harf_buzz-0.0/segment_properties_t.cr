module HarfBuzz
  ...
  class SegmentPropertiesT
    ...
    def self.new(direction : HarfBuzz::DirectionT? = nil, script : HarfBuzz::ScriptT? = nil, language : HarfBuzz::LanguageT? = nil, reserved1 : Pointer(Nil)? = nil, reserved2 : Pointer(Nil)? = nil)

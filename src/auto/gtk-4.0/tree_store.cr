...
module Gtk
  ...
  class TreeStore < GObject::Object
    ...
    GICrystal.define_new_method(TreeStore, g_object_get_qdata, g_object_set_qdata)
    ...
    def append(parent : Gtk::TreeIter?) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_append(@pointer, iter, parent)
    ...
    def clear : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_clear(@pointer)
    ...
    def insert(parent : Gtk::TreeIter?, position : Int32) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_insert(@pointer, iter, parent, position)
    ...
    def insert_after(parent : Gtk::TreeIter?, sibling : Gtk::TreeIter?) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_insert_after(@pointer, iter, parent, sibling)
    ...
    def insert_before(parent : Gtk::TreeIter?, sibling : Gtk::TreeIter?) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_insert_before(@pointer, iter, parent, sibling)
    ...
    def insert_with_values(parent : Gtk::TreeIter?, position : Int32, columns : Enumerable(Int32), values : Enumerable(_)) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_insert_with_valuesv(@pointer, iter, parent, position, columns, values, n_values)
    ...
    def is_ancestor(iter : Gtk::TreeIter, descendant : Gtk::TreeIter) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_tree_store_is_ancestor(@pointer, iter, descendant)
    ...
    def iter_depth(iter : Gtk::TreeIter) : Int32
      ...
      # C call
      _retval = LibGtk.gtk_tree_store_iter_depth(@pointer, iter)
    ...
    def iter_is_valid(iter : Gtk::TreeIter) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_tree_store_iter_is_valid(@pointer, iter)
    ...
    def move_after(iter : Gtk::TreeIter, position : Gtk::TreeIter?) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_move_after(@pointer, iter, position)
    ...
    def move_before(iter : Gtk::TreeIter, position : Gtk::TreeIter?) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_move_before(@pointer, iter, position)
    ...
    def prepend(parent : Gtk::TreeIter?) : Gtk::TreeIter
      ...
      # C call
      LibGtk.gtk_tree_store_prepend(@pointer, iter, parent)
    ...
    def remove(iter : Gtk::TreeIter) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_tree_store_remove(@pointer, iter)
    ...
    def column_types=(types : Enumerable(UInt64)) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_set_column_types(@pointer, n_columns, types)
    ...
    def set_value(iter : Gtk::TreeIter, column : Int32, value : _) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_set_value(@pointer, iter, column, value)
    ...
    def set(iter : Gtk::TreeIter, columns : Enumerable(Int32), values : Enumerable(_)) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_set_valuesv(@pointer, iter, columns, values, n_values)
    ...
    def swap(a : Gtk::TreeIter, b : Gtk::TreeIter) : Nil
      ...
      # C call
      LibGtk.gtk_tree_store_swap(@pointer, a, b)

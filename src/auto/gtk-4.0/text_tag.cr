...
module Gtk
  ...
  class TextTag < GObject::Object
    ...
    GICrystal.define_new_method(TextTag, g_object_get_qdata, g_object_set_qdata)
    ...
    def changed(size_changed : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_text_tag_changed(@pointer, size_changed)
    ...
    def priority : Int32
      ...
      # C call
      _retval = LibGtk.gtk_text_tag_get_priority(@pointer)
    ...
    def priority=(priority : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_text_tag_set_priority(@pointer, priority)

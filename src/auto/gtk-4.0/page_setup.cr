...
module Gtk
  ...
  class PageSetup < GObject::Object
    ...
    def self.new_from_file(file_name : ::String) : Gtk::PageSetup
      # gtk_page_setup_new_from_file: (Constructor | Throws)
      # Returns: (transfer full)

      _retval = LibGtk.gtk_page_setup_new_from_file(file_name)
      Gtk::PageSetup.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_from_gvariant(variant : _) : Gtk::PageSetup
    ...
    def self.new_from_key_file(key_file : GLib::KeyFile, group_name : ::String?) : Gtk::PageSetup
      ...
      _retval = LibGtk.gtk_page_setup_new_from_key_file(key_file, group_name)
      Gtk::PageSetup.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def load_file(file_name : ::String) : Bool
      ...
      _retval = LibGtk.gtk_page_setup_load_file(self, file_name)
    ...
    def load_key_file(key_file : GLib::KeyFile, group_name : ::String?) : Bool
      ...
      _retval = LibGtk.gtk_page_setup_load_key_file(self, key_file, group_name)
      GICrystal.to_bool(_retval)
    end
    ...
    def to_file(file_name : ::String) : Bool
      ...
      _retval = LibGtk.gtk_page_setup_to_file(self, file_name)
      GICrystal.to_bool(_retval)
    end

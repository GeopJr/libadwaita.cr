...
module Gtk
  ...
  class FileChooserWidget < Widget
    ...
    struct DesktopFolderSignal
      ...
      def connect(block : Proc(Gtk::FileChooserWidget, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::FileChooserWidget, Nil)).unbox(box).call(sender)
        }
      ...
      def connect_after(block : Proc(Gtk::FileChooserWidget, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::FileChooserWidget, Nil)).unbox(box).call(sender)
    ...
    struct LocationPopupSignal
      ...
      def connect(block : Proc(Gtk::FileChooserWidget, ::String, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Pointer(LibC::Char), box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          arg0 = ::String.new(lib_arg0)
          ::Box(Proc(Gtk::FileChooserWidget, ::String, Nil)).unbox(box).call(sender, arg0)
        }
      ...
      def connect_after(block : Proc(Gtk::FileChooserWidget, ::String, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Pointer(LibC::Char), box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          arg0 = ::String.new(lib_arg0)
    ...
    struct QuickBookmarkSignal
      ...
      def connect(block : Proc(Gtk::FileChooserWidget, Int32, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Int32, box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          arg0 = lib_arg0
          ::Box(Proc(Gtk::FileChooserWidget, Int32, Nil)).unbox(box).call(sender, arg0)
        }
      ...
      def connect_after(block : Proc(Gtk::FileChooserWidget, Int32, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Int32, box : Pointer(Void)) {
          sender = Gtk::FileChooserWidget.new(lib_sender, GICrystal::Transfer::None)
          arg0 = lib_arg0

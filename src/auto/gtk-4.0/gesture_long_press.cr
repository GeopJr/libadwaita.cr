...
module Gtk
  ...
  class GestureLongPress < GestureSingle
    ...
    struct CancelledSignal
      ...
      def connect(block : Proc(Gtk::GestureLongPress, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), box : Pointer(Void)) {
          sender = Gtk::GestureLongPress.new(lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::GestureLongPress, Nil)).unbox(box).call(sender)
        }
      ...
      def connect_after(block : Proc(Gtk::GestureLongPress, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), box : Pointer(Void)) {
          sender = Gtk::GestureLongPress.new(lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::GestureLongPress, Nil)).unbox(box).call(sender)
    ...
    struct PressedSignal
      ...
      def connect(block : Proc(Gtk::GestureLongPress, Float64, Float64, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Float64, lib_arg1 : Float64, box : Pointer(Void)) {
          sender = Gtk::GestureLongPress.new(lib_sender, GICrystal::Transfer::None)
          arg0 = lib_arg0
          arg1 = lib_arg1
          ::Box(Proc(Gtk::GestureLongPress, Float64, Float64, Nil)).unbox(box).call(sender, arg0, arg1)
        }
      ...
      def connect_after(block : Proc(Gtk::GestureLongPress, Float64, Float64, Nil))
        box = ::Box.box(block)
        slot = ->(lib_sender : Pointer(Void), lib_arg0 : Float64, lib_arg1 : Float64, box : Pointer(Void)) {
          sender = Gtk::GestureLongPress.new(lib_sender, GICrystal::Transfer::None)
          arg0 = lib_arg0

...
module Gtk
  ...
  class MessageDialog < Dialog
    ...
    GICrystal.define_new_method(MessageDialog, g_object_get_qdata, g_object_set_qdata)
    ...
    def message_area : Gtk::Widget
      ...
      # C call
      _retval = LibGtk.gtk_message_dialog_get_message_area(@pointer)
    ...
    def markup=(str : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_message_dialog_set_markup(@pointer, str)

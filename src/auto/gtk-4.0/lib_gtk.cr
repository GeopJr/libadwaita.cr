...
lib LibGtk
  ...
  fun gtk_builder_add_from_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  fun gtk_builder_add_from_resource(this : Void*, resource_path : Pointer(LibC::Char)) : LibC::Int
  fun gtk_builder_add_from_string(this : Void*, buffer : Pointer(LibC::Char), length : Int64) : LibC::Int
  fun gtk_builder_add_objects_from_file(this : Void*, filename : Pointer(LibC::Char), object_ids : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun gtk_builder_add_objects_from_resource(this : Void*, resource_path : Pointer(LibC::Char), object_ids : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun gtk_builder_add_objects_from_string(this : Void*, buffer : Pointer(LibC::Char), length : Int64, object_ids : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun gtk_builder_create_closure(this : Void*, function_name : Pointer(LibC::Char), flags : UInt32, object : Pointer(Void)) : Pointer(Void)
  ...
  fun gtk_builder_extend_with_template(this : Void*, object : Pointer(Void), template_type : UInt64, buffer : Pointer(LibC::Char), length : Int64) : LibC::Int
  ...
  fun gtk_builder_value_from_string(this : Void*, pspec : Pointer(Void), string : Pointer(LibC::Char), value : Pointer(Void)) : LibC::Int
  fun gtk_builder_value_from_string_type(this : Void*, type : UInt64, string : Pointer(LibC::Char), value : Pointer(Void)) : LibC::Int
  ...
  fun gtk_constraint_layout_add_constraints_from_descriptionv(this : Void*, lines : Pointer(Pointer(LibC::Char)), n_lines : UInt64, hspacing : Int32, vspacing : Int32, views : Pointer(Void)) : Pointer(LibGLib::List)
  ...
  fun gtk_file_chooser_add_shortcut_folder(this : Void*, folder : Pointer(Void)) : LibC::Int
  ...
  fun gtk_file_chooser_remove_shortcut_folder(this : Void*, folder : Pointer(Void)) : LibC::Int
  ...
  fun gtk_file_chooser_set_current_folder(this : Void*, file : Pointer(Void)) : LibC::Int
  fun gtk_file_chooser_set_current_name(this : Void*, name : Pointer(LibC::Char)) : Void
  fun gtk_file_chooser_set_file(this : Void*, file : Pointer(Void)) : LibC::Int
  ...
  fun gtk_page_setup_load_file(this : Void*, file_name : Pointer(LibC::Char)) : LibC::Int
  fun gtk_page_setup_load_key_file(this : Void*, key_file : Pointer(Void), group_name : Pointer(LibC::Char)) : LibC::Int
  fun gtk_page_setup_new : Pointer(Void)
  fun gtk_page_setup_new_from_file(file_name : Pointer(LibC::Char)) : Pointer(Void)
  fun gtk_page_setup_new_from_gvariant(variant : Pointer(Void)) : Pointer(Void)
  fun gtk_page_setup_new_from_key_file(key_file : Pointer(Void), group_name : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun gtk_page_setup_to_file(this : Void*, file_name : Pointer(LibC::Char)) : LibC::Int
  ...
  fun gtk_paper_size_new_from_key_file(key_file : Pointer(Void), group_name : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun gtk_print_job_get_surface(this : Void*) : Pointer(Void)
  ...
  fun gtk_print_job_set_source_fd(this : Void*, fd : Int32) : LibC::Int
  fun gtk_print_job_set_source_file(this : Void*, filename : Pointer(LibC::Char)) : LibC::Int
  ...
  fun gtk_print_operation_get_error(this : Void*) : Void
  ...
  fun gtk_print_operation_run(this : Void*, action : UInt32, parent : Pointer(Void)) : UInt32
  ...
  fun gtk_print_settings_load_file(this : Void*, file_name : Pointer(LibC::Char)) : LibC::Int
  fun gtk_print_settings_load_key_file(this : Void*, key_file : Pointer(Void), group_name : Pointer(LibC::Char)) : LibC::Int
  fun gtk_print_settings_new : Pointer(Void)
  fun gtk_print_settings_new_from_file(file_name : Pointer(LibC::Char)) : Pointer(Void)
  fun gtk_print_settings_new_from_gvariant(variant : Pointer(Void)) : Pointer(Void)
  fun gtk_print_settings_new_from_key_file(key_file : Pointer(Void), group_name : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun gtk_print_settings_to_file(this : Void*, file_name : Pointer(LibC::Char)) : LibC::Int
  ...
  fun gtk_recent_info_create_app_info(this : Void*, app_name : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun gtk_recent_manager_lookup_item(this : Void*, uri : Pointer(LibC::Char)) : Pointer(Void)
  fun gtk_recent_manager_move_item(this : Void*, uri : Pointer(LibC::Char), new_uri : Pointer(LibC::Char)) : LibC::Int
  fun gtk_recent_manager_new : Pointer(Void)
  fun gtk_recent_manager_purge_items(this : Void*) : Int32
  fun gtk_recent_manager_remove_item(this : Void*, uri : Pointer(LibC::Char)) : LibC::Int
  ...
  fun gtk_show_uri_full_finish(parent : Pointer(Void), result : Pointer(Void)) : LibC::Int

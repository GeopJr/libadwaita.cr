...
module Gtk
  ...
  class GestureSwipe < GestureSingle
    ...
    GICrystal.define_new_method(GestureSwipe, g_object_get_qdata, g_object_set_qdata)
    ...
    def velocity(velocity_x : Float64, velocity_y : Float64) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_gesture_swipe_get_velocity(@pointer, velocity_x, velocity_y)

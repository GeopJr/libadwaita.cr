module Gtk
  ...
  class BuildableParser
    ...
    def self.new(start_element : Pointer(Void)? = nil, end_element : Pointer(Void)? = nil, text : Pointer(Void)? = nil, error : Pointer(Void)? = nil, padding : Enumerable(Pointer(Nil))? = nil)

...
module Gtk
  ...
  class LayoutChild < GObject::Object
    ...
    GICrystal.define_new_method(LayoutChild, g_object_get_qdata, g_object_set_qdata)
    ...
    def child_widget : Gtk::Widget
      ...
      # C call
      _retval = LibGtk.gtk_layout_child_get_child_widget(@pointer)
    ...
    def layout_manager : Gtk::LayoutManager
      ...
      # C call
      _retval = LibGtk.gtk_layout_child_get_layout_manager(@pointer)

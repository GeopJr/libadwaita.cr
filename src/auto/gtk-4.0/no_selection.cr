...
module Gtk
  ...
  class NoSelection < GObject::Object
    ...
    GICrystal.define_new_method(NoSelection, g_object_get_qdata, g_object_set_qdata)
    ...
    def model : Gio::ListModel?
      ...
      # C call
      _retval = LibGtk.gtk_no_selection_get_model(@pointer)
    ...
    def model=(model : Gio::ListModel?) : Nil
      ...
      # C call
      LibGtk.gtk_no_selection_set_model(@pointer, model)

...
module Gtk
  ...
  class TreeModelFilter < GObject::Object
    ...
    def set_modify_func(types : Enumerable(UInt64), func : Pointer(Void), data : Pointer(Nil)?, destroy : Pointer(Void)?) : Nil
    ...
    def set_visible_func(func : Pointer(Void), data : Pointer(Nil)?, destroy : Pointer(Void)?) : Nil

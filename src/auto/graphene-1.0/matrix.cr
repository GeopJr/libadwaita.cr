module Graphene
  ...
  class Matrix
    ...
    def value : Graphene::Simd4X4F
      # Property getter
      _var = (@pointer + 0).as(Pointer(LibGraphene::Simd4X4F))
      Graphene::Simd4X4F.new(_var.value, GICrystal::Transfer::Full)
    end

    def value=(value : Graphene::Simd4X4F)
      # Property setter
      _var = (@pointer + 0).as(Pointer(LibGraphene::Simd4X4F)).value = value.to_unsafe
      value
    end
    ...
    def self.alloc : Graphene::Matrix

module Graphene
  class Simd4X4F
    ...
    def y : Graphene::Simd4F
      # Property getter
      _var = (@pointer + 16).as(Pointer(LibGraphene::Simd4F))
      Graphene::Simd4F.new(_var.value, GICrystal::Transfer::Full)
    end

    def y=(value : Graphene::Simd4F)
      # Property setter
      _var = (@pointer + 16).as(Pointer(LibGraphene::Simd4F)).value = value.to_unsafe
      value
    end

    def z : Graphene::Simd4F
      # Property getter
      _var = (@pointer + 32).as(Pointer(LibGraphene::Simd4F))
      Graphene::Simd4F.new(_var.value, GICrystal::Transfer::Full)
    end

    def z=(value : Graphene::Simd4F)
      # Property setter
      _var = (@pointer + 32).as(Pointer(LibGraphene::Simd4F)).value = value.to_unsafe
      value
    end

    def w : Graphene::Simd4F
      # Property getter
      _var = (@pointer + 48).as(Pointer(LibGraphene::Simd4F))
      Graphene::Simd4F.new(_var.value, GICrystal::Transfer::Full)
    end

    def w=(value : Graphene::Simd4F)
      # Property setter
      _var = (@pointer + 48).as(Pointer(LibGraphene::Simd4F)).value = value.to_unsafe
      value
    end
